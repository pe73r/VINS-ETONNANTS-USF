/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 9/29/2023 2:40:17 AM*/
...
<li class="usf-sr-product usf-grid__item" :product-selector="product.id" :data-usf-pid="product.id">
   <div class="card-product p-5 rounded-md bg-white shadow-md ">
        ...
        <div class="group relative mt-3 flex gap-1" v-if="!isSoldOut">
            ...
            <add-to-cart data-nm="Y" data-max-quantity="0" :data-quantity="usfQty" class="w-8/12 " :data-product="product.id" :data-title="product.title" :data-price="price" :data-variant="product.variants[0].id">
...
function _usfGetScaledImageUrl(url, size = "{width}") {
  if (_usfIsDynamicImage) return url.replace("{size}", size);
...
function _usfGetOriginImgWithSize(url, size = "50x50") {
  ...
  if (n != -1) return url.substring(0, n) + "_" + size + url.substring(n);
  else return url;
}
...
function _usfAddToCart(e, callback) {
  ...
  fetch(usf.platform.baseUrl + "/cart/add.js", {
    ...
    if (response.ok) {
      ...
      response
        .json()
        .then((rs) => (typeof _usfOnAddToCartSuccess === "function" ? _usfOnAddToCartSuccess(rs, formElement) : null));
      ...
      response.json().then(function (content) {
        ...
        if (shouldUpdateLbl) {
          if (!lbl._oldText) lbl._oldText = lbl.innerHTML;
          lbl.innerHTML = errorMsg;
        }

        clsList.add("usf-has-error");
        setTimeout(function () {
          if (lbl._oldText) lbl.innerHTML = lbl._oldText;
...
!(function (e, t) {
  ...
  function u(e) {
    return null == e ? "" : Array.isArray(e) || (a(e) && e.toString === o) ? JSON.stringify(e, null, 2) : String(e);
  }
  function l(e) {
    var t = parseFloat(e);
    return isNaN(t) ? e : t;
  ...
  var I = new RegExp("[^" + D.source + ".$_\\d]");
  var M,
    P = "__proto__" in {},
    E = "undefined" != typeof window,
    L = E && window.navigator.userAgent.toLowerCase(),
    R = L && L.indexOf("edge/") > 0,
    H = (L && L.indexOf("android"), L && /iphone|ipad|ipod|ios/.test(L)),
    U = (L && /chrome\/\d+/.test(L), L && /phantomjs/.test(L), L && L.match(/firefox\/(\d+)/)),
    B = {}.watch,
    z = !1;
  if (E)
    try {
  ...
  var K = function () {
    return (
      void 0 === M &&
        (M = !E && "undefined" != typeof global && global.process && "server" === global.process.env.VUE_ENV),
      M
    );
  };
  function J(e) {
  ...
  var q,
    Z = "undefined" != typeof Symbol && J(Symbol) && "undefined" != typeof Reflect && J(Reflect.ownKeys);
  q =
  ...
  (ee.prototype.addSub = function (e) {
    this.subs.push(e);
  }),
    (ee.prototype.removeSub = function (e) {
      v(this.subs, e);
    }),
    (ee.prototype.depend = function () {
      ee.target && ee.target.addDep(this);
    }),
    (ee.prototype.notify = function () {
      for (var e = this.subs.slice(), t = 0, n = e.length; t < n; t++) e[t].update();
    }),
    (ee.target = null);
  var te = [];
  function ne(e) {
    te.push(e), (ee.target = e);
  }
  function re() {
    te.pop(), (ee.target = te[te.length - 1]);
  }
  ...
  var fe = Object.getOwnPropertyNames(le),
    pe = !0;
  function de(e) {
    pe = e;
  }
  ...
  function he(e, t) {
    ...
    if (i(e) && !(e instanceof ie))
      return (
        m(e, "__ob__") && e.__ob__ instanceof ve
          ? (n = e.__ob__)
          : pe && !K() && (Array.isArray(e) || a(e)) && Object.isExtensible(e) && !e._isVue && (n = new ve(e)),
        t && n && n.vmCount++,
        n
      );
  }
  function me(e, t, n, r, i) {
    ...
    if (!a || !1 !== a.configurable) {
      ...
      Object.defineProperty(e, t, {
        ...
        set: function (t) {
          var r = s ? s.call(e) : n;
          t === r || (t != t && r != r) || (s && !c) || (c ? c.call(e, t) : (n = t), (u = !i && he(t)), o.notify());
        }
      });
    }
  }
  ...
  function be(e, t) {
    if (!t) return e;
    for (var n, r, i, o = Z ? Reflect.ownKeys(t) : Object.keys(t), s = 0; s < o.length; s++)
      "__ob__" !== (n = o[s]) && ((r = e[n]), (i = t[n]), m(e, n) ? r !== i && a(r) && a(i) && be(r, i) : ye(e, n, i));
    return e;
  }
  function $e(e, t, n) {
    return n
  ...
  for (var xe = 0; xe < Y.length; xe++) _e[Y[xe]] = we;
  function Ae(e, t, n, r) {
    var i = Object.create(e || null);
    return t ? k(i, t) : i;
  }
  for (var ke = 0; ke < G.length; ke++) _e[G[ke] + "s"] = Ae;
  (_e.watch = function (e, t, n, r) {
    if ((e === B && (e = void 0), t === B && (t = void 0), !t)) return Object.create(e || null);
    if (!e) return t;
    var i = {};
    ...
    if (
      ...
      (function (e, t) {
        ...
        if (n) {
          ...
          else if (a(n)) for (var s in n) (i = n[s]), (o[_(s)] = a(i) ? i : { type: i });
          e.props = o;
        }
      })(t),
      (function (e, t) {
      ...
      !t._base && (t.extends && (e = Ce(e, t.extends, n)), t.mixins))
    )
      for (var r = 0, i = t.mixins.length; r < i; r++) e = Ce(e, t.mixins[r], n);
    var o,
      s = {};
    for (o in e) c(o);
    for (o in t) m(e, o) || c(o);
    function c(r) {
      var i = _e[r] || Oe;
      s[r] = i(e[r], t[r], n, r);
    }
  ...
  function Me(e, t, n) {
    !(function (e, t, n) {
      if (!E || "undefined" == typeof console) throw e;
      console.error(e);
    })(e);
  }
  var Pe,
  ...
  if ("undefined" != typeof Promise && J(Promise)) {
    ...
    (Pe = function () {
      Ue.then(He), H && setTimeout(C);
    }),
      (Ee = !0);
  } else if (
    "undefined" == typeof MutationObserver ||
    (!J(MutationObserver) && "[object MutationObserverConstructor]" !== MutationObserver.toString())
  )
    Pe =
      "undefined" != typeof setImmediate && J(setImmediate)
        ? function () {
            setImmediate(He);
          }
        : function () {
    ...
    var Be = 1,
      ze = new MutationObserver(He),
      Ve = document.createTextNode(String(Be));
    ze.observe(Ve, { characterData: !0 }),
      (Pe = function () {
        (Be = (Be + 1) % 2), (Ve.data = String(Be));
      }),
      (Ee = !0);
  }
  function Ke(e, t) {
  ...
  function qe(e) {
    !(function e(t, n) {
      ...
      if ((!a && !i(t)) || Object.isFrozen(t) || t instanceof ie) return;
      if (t.__ob__) {
  ...
  function Ge(e, n, r, i, o, a) {
    ...
    for (s in e)
      (c = e[s]),
        ...
        t(c) ||
          (t(u)
            ? (t(c.fns) && (c = e[s] = We(c, a)),
              !0 === l.once && (c = e[s] = o(l.name, c, l.capture)),
              r(l.name, c, l.capture, l.passive, l.params))
            : c !== u && ((u.fns = c), (e[s] = u)));
    for (s in n) t(e[s]) && i((l = Ze(s)).name, n[s], l.capture);
  }
  function Ye(e, r, i) {
    var o;
    ...
    var a = e[r];
    function s() {
      i.apply(this, arguments), v(o.fns, s);
    }
    t(a) ? (o = We([s])) : n(a.fns) && !0 === a.merged ? (o = a).fns.push(s) : (o = We([a, s])),
      (o.merged = !0),
      (e[r] = o);
  }
  function Qe(e, t, r, i, o) {
    if (n(t)) {
      if (m(t, r)) return (e[r] = t[r]), o || delete t[r], !0;
      if (m(t, i)) return (e[r] = t[i]), o || delete t[i], !0;
    }
    return !1;
  }
  function Xe(e) {
      ...
      ? (function e(i, o) {
          ...
          for (s = 0; s < i.length; s++)
            t((c = i[s])) ||
              ...
              Array.isArray(c)
                ? c.length > 0 &&
                  (et((c = e(c, (o || "") + "_" + s))[0]) && et(l) && ((a[u] = se(l.text + c[0].text)), c.shift()),
                  a.push.apply(a, c))
                : r(c)
                ? et(l)
                  ? (a[u] = se(l.text + c))
                  : "" !== c && a.push(se(c))
                : et(c) && et(l)
                ? (a[u] = se(l.text + c.text))
                : (!0 === i._isVList && n(c.tag) && t(c.key) && n(o) && (c.key = "__vlist" + o + "_" + s + "__"),
                  a.push(c)));
          return a;
        })(e)
      : void 0;
  ...
  function it(t, n, r) {
    ...
    if (t) {
      ...
      for (var c in ((i = {}), t)) t[c] && "$" !== c[0] && (i[c] = ot(n, c, t[c]));
    } else i = {};
    for (var u in n) u in i || (i[u] = at(n, u));
    return (
      t && Object.isExtensible(t) && (t._normalized = i), F(i, "$stable", a), F(i, "$key", s), F(i, "$hasNormal", o), i
    );
  }
  function ot(e, t, n) {
    var r = function () {
      var e = arguments.length ? n.apply(null, arguments) : n({});
      return (e = e && "object" == typeof e && !Array.isArray(e) ? [e] : Xe(e)) &&
  ...
  function st(e, t) {
    ...
    if (Array.isArray(e) || "string" == typeof e)
      for (r = new Array(e.length), o = 0, a = e.length; o < a; o++) r[o] = t(e[o], o);
      ...
      if (Z && e[Symbol.iterator]) {
        ...
        for (s = Object.keys(e), r = new Array(s.length), o = 0, a = s.length; o < a; o++)
          (c = s[o]), (r[o] = t(e[c], c, o));
  ...
  function lt(e, t, n, r, i) {
    ...
    return i && r && !Q.keyCodes[t] ? ut(i, r) : o ? ut(o, e) : r ? w(r) !== t : void 0;
  }
  function ft(e, t, n, r, o) {
    if (n)
      if (i(n)) {
        ...
        var s = function (i) {
          if ("class" === i || "style" === i || d(i)) a = e;
          else {
            var s = e.attrs && e.attrs.type;
            a = r || Q.mustUseProp(t, s, i) ? e.domProps || (e.domProps = {}) : e.attrs || (e.attrs = {});
          }
          var c = _(i),
            u = w(i);
          c in a ||
  ...
  function pt(e, t) {
    ...
    return r && !t
      ? r
      : (vt((r = n[e] = this.$options.staticRenderFns[e].call(this._renderProxy, null, this)), "__static__" + e, !1),
        r);
  }
  function dt(e, t, n) {
  ...
  function $t(t, n, r, i, o) {
    ...
    (this.data = t),
      ...
      (this.injections = tt(c.inject, i)),
      (this.slots = function () {
        return s.$slots || it(t.scopedSlots, (s.$slots = nt(r, i))), s.$slots;
      }),
      Object.defineProperty(this, "scopedSlots", {
        enumerable: !0,
        get: function () {
          return it(t.scopedSlots, this.slots());
        }
      }),
      u && ((this.$options = c), (this.$slots = this.slots()), (this.$scopedSlots = it(t.scopedSlots, this.$slots))),
      c._scopeId
        ? (this._c = function (e, t, n, r) {
            var o = jt(a, e, t, n, r, l);
            return o && !Array.isArray(o) && ((o.fnScopeId = c._scopeId), (o.fnContext = i)), o;
          })
        : (this._c = function (e, t, n, r) {
            return jt(a, e, t, n, r, l);
          });
  }
  function wt(e, t, n, r) {
    var i = ce(e);
      ...
      prepatch: function (t, n) {
        ...
        !(function (t, n, r, i, o) {
          ...
          if (
            ...
            de(!0), (t.$options.propsData = n);
          }
          r = r || e;
          var h = t.$options._parentListeners;
          (t.$options._parentListeners = r), Et(t, r, h), u && ((t.$slots = nt(o, i.context)), t.$forceUpdate());
        })((n.componentInstance = t.componentInstance), r.propsData, r.listeners, n, r.children);
      },
      insert: function (e) {
        e.context;
        var t = e.componentInstance;
        t._isMounted || ((t._isMounted = !0), Ht(t, "mounted"));
      },
      destroy: function (e) {
        var t = e.componentInstance;
        t._isDestroyed || t.$destroy();
      }
    },
    kt = Object.keys(At);
  function Ot(r, o, a, s, u) {
    if (!t(r)) {
      ...
      if ((i(r) && (r = l.extend(r)), "function" == typeof r)) {
        ...
        if (
          ...
          void 0 ===
            (r = (function (e, r) {
              if (!0 === e.error && n(e.errorComp)) return e.errorComp;
              if (n(e.resolved)) return e.resolved;
              var o = Dt;
              o && n(e.owners) && -1 === e.owners.indexOf(o) && e.owners.push(o);
              if (!0 === e.loading && n(e.loadingComp)) return e.loadingComp;
              if (o && !n(e.owners)) {
                var a = (e.owners = [o]),
                  s = !0,
                  u = null,
                ...
                var f = function (e) {
                  ...
                  p = N(function (t) {
                    (e.resolved = Ft(t, r)), s ? (a.length = 0) : f(!0);
                  }),
                  d = N(function (t) {
                ...
                return (
                  i(h) &&
                    (c(h)
                      ? t(e.resolved) && h.then(p, d)
                      : c(h.component) &&
                        (h.component.then(p, d),
                        n(h.error) && (e.errorComp = Ft(h.error, r)),
                        n(h.loading) &&
                          ((e.loadingComp = Ft(h.loading, r)),
                          0 === h.delay
                            ? (e.loading = !0)
        ...
        if (!0 === r.options.functional)
          return (function (t, r, i, o, a) {
            var s = t.options,
              c = {},
              u = s.props;
            if (n(u)) for (var l in u) c[l] = Te(l, u, r || e);
            else n(i.attrs) && xt(c, i.attrs), n(i.props) && xt(c, i.props);
            var f = new $t(i, c, a, o, t),
              p = s.render.call(null, f._c, f);
            if (p instanceof ie) return wt(p, i, f.parent, s);
            if (Array.isArray(p)) {
              for (var d = Xe(p) || [], v = new Array(d.length), h = 0; h < d.length; h++)
                v[h] = wt(d[h], i, f.parent, s);
              return v;
            }
          })(r, p, o, a, s);
        var d = o.on;
        if (((o.on = o.nativeOn), !0 === r.options.abstract)) {
          var h = o.slot;
          (o = {}), h && (o.slot = h);
        }
        !(function (e) {
        ...
        return new ie(
          "vue-component-" + r.cid + (m ? "-" + m : ""),
          o,
          void 0,
          void 0,
          void 0,
          a,
          { Ctor: r, propsData: p, listeners: d, tag: u, children: s },
          f
        );
      }
    }
  ...
  var St = 1,
    Tt = 2;
  function jt(e, o, a, s, c, u) {
    return (
      (Array.isArray(a) || r(a)) && ((c = s), (s = a), (a = void 0)),
      !0 === u && (c = Tt),
      (function (e, r, o, a, s) {
        if (n(o) && n(o.__ob__)) return ae();
        n(o) && n(o.is) && (r = o.is);
        if (!r) return ae();
        Array.isArray(a) &&
          "function" == typeof a[0] &&
          (((o = o || {}).scopedSlots = { default: a[0] }), (a.length = 0));
        s === Tt
          ? (a = Xe(a))
          : s === St &&
            (a = (function (e) {
        ...
        if ("string" == typeof r) {
          var l;
          (u = (e.$vnode && e.$vnode.ns) || Q.getTagNamespace(r)),
            (c = Q.isReservedTag(r)
              ? new ie(Q.parsePlatformTagName(r), o, a, void 0, void 0, e)
              : (o && o.pre) || !n((l = Se(e.$options, "components", r)))
              ? new ie(r, o, a, void 0, void 0, e)
              : Ot(l, o, e, a, r));
        } else c = Ot(r, o, e, a);
        return Array.isArray(c)
          ...
          ? (n(u) &&
              (function e(r, i, o) {
                r.ns = i;
                "foreignObject" === r.tag && ((i = void 0), (o = !0));
                if (n(r.children))
                  for (var a = 0, s = r.children.length; a < s; a++) {
                    var c = r.children[a];
                    n(c.tag) && (t(c.ns) || (!0 === o && "svg" !== c.tag)) && e(c, i, o);
                  }
              })(c, u),
            n(o) &&
              (function (e) {
                i(e.style) && qe(e.style);
                i(e.class) && qe(e.class);
              })(o),
            c)
          : ae();
      })(e, o, a, s, c)
  ...
  var Nt,
    Dt = null;
  function Ft(e, t) {
    return (e.__esModule || (Z && "Module" === e[Symbol.toStringTag])) && (e = e.default), i(e) ? t.extend(e) : e;
  }
  function It(e, t) {
    Nt.$on(e, t);
  }
  ...
  function Et(e, t, n) {
    (Nt = e), Ge(t, n || {}, It, Mt, Pt, e), (Nt = void 0);
  }
  var Lt = null;
  function Rt(e, t) {
    if (t) {
  ...
  var qt = 0,
    Zt = Date.now;
  if (E) {
    var Wt = window.performance;
    Wt &&
      "function" == typeof Wt.now &&
  ...
  function Gt() {
    ...
    for (
      ...
      (e = Ut[Jt]).before && e.before(), (t = e.id), (zt[t] = null), e.run();
    var n = Bt.slice(),
      r = Ut.slice();
    (Jt = Ut.length = Bt.length = 0),
      (zt = {}),
      (Vt = Kt = !1),
      (function (e) {
  ...
  (Qt.prototype.get = function () {
    ...
    try {
      ...
      this.deep && qe(e), re(), this.cleanupDeps();
    }
    return e;
  }),
    ...
    (Qt.prototype.update = function () {
      this.lazy
        ...
        : (function (e) {
            ...
            if (null == zt[t]) {
              if (((zt[t] = !0), Kt)) {
                for (var n = Ut.length - 1; n > Jt && Ut[n].id > e.id; ) n--;
                Ut.splice(n + 1, 0, e);
              } else Ut.push(e);
              Vt || ((Vt = !0), Ke(Gt));
            }
  ...
  var Xt = { enumerable: !0, configurable: !0, get: C, set: C };
  function en(e, t, n) {
    (Xt.get = function () {
      return this[t][n];
    }),
  ...
  function tn(e) {
    ...
    t.props &&
      ...
      t.methods &&
        (function (e, t) {
          e.$options.props;
          for (var n in t) e[n] = "function" != typeof t[n] ? C : x(t[n], e);
        })(e, t.methods),
      t.data
        ? (function (e) {
            ...
            for (; i--; ) {
              var o = n[i];
              (r && m(r, o)) || ((s = void 0), 36 !== (s = (o + "").charCodeAt(0)) && 95 !== s && en(e, "_data", o));
            }
            var s;
            he(t, !0);
          })(e)
      ...
      t.computed &&
        (function (e, t) {
          ...
          for (var i in t) {
            ...
            r || (n[i] = new Qt(e, a || C, C, nn)), i in e || rn(e, i, o);
          }
        })(e, t.computed),
      t.watch &&
        t.watch !== B &&
  ...
  function rn(e, t, n) {
    var r = !K();
    "function" == typeof n
      ? ((Xt.get = r ? on(t) : an(n)), (Xt.set = C))
      : ((Xt.get = n.get ? (r && !1 !== n.cache ? on(t) : an(n.get)) : C), (Xt.set = n.set || C)),
  ...
  function un(e) {
    ...
    if (e.super) {
      ...
      if (n !== e.superOptions) {
        ...
        r && k(e.extendOptions, r), (t = e.options = Ce(n, e.extendOptions)).name && (t.components[t.name] = e);
      }
    }
    return t;
  }
  ...
  function fn(e) {
    ...
    e.extend = function (e) {
      ...
      var n = this.cid,
        r = e._Ctor || (e._Ctor = {});
      if (r[n]) return r[n];
      var i = e.name || this.options.name,
        o = function (e) {
          this._init(e);
        };
      ((o.prototype = Object.create(this.prototype)).constructor = o),
        (o.cid = t++),
        (o.options = Ce(this.options, e)),
        (o.super = this),
        o.options.props &&
          (function (e) {
      ...
      for (var a = 0; a < G.length; a++) o[G[a]] = this[G[a]];
      return (
  ...
  !(function (t) {
    t.prototype._init = function (t) {
      ...
      (n._uid = cn++),
        ...
        t && t._isComponent
          ...
          : (n.$options = Ce(un(n.constructor), t || {}, n)),
        (n._renderProxy = n),
        (n._self = n),
        (function (e) {
          var t = e.$options,
        ...
        (function (t) {
          ...
          var n = t.$options,
            ...
            i = r && r.context;
          (t.$slots = nt(n._renderChildren, i)),
            (t.$scopedSlots = e),
          ...
          var o = r && r.data;
          me(t, "$attrs", (o && o.attrs) || e, null, !0), me(t, "$listeners", n._parentListeners || e, null, !0);
        })(n),
        Ht(n, "beforeCreate"),
        (function (e) {
    ...
    (function (e) {
      ...
      Object.defineProperty(e.prototype, "$data", t),
        ...
        (e.prototype.$set = ye),
        (e.prototype.$delete = ge),
        (e.prototype.$watch = function (e, t, n) {
          if (a(t)) return sn(this, e, t, n);
          (n = n || {}).user = !0;
    ...
    (function (e) {
      bt(e.prototype),
        ...
        (e.prototype._render = function () {
          ...
          return Array.isArray(e) && 1 === e.length && (e = e[0]), e instanceof ie || (e = ae()), (e.parent = i), e;
        });
    })(ln),
    (function (e) {
      var t = {
      ...
      Object.defineProperty(e, "config", t), (e.options = Object.create(null));
      for (var n = 0; n < G.length; n++) e.options[G[n] + "s"] = Object.create(null);
      (e.options._base = e),
        fn(e),
        (function (e) {
    ...
    Object.defineProperty(ln.prototype, "$isServer", { get: K }),
    Object.defineProperty(ln.prototype, "$ssrContext", {
      get: function () {
        return this.$vnode && this.$vnode.ssrContext;
      }
    }),
    Object.defineProperty(ln, "FunctionalRenderContext", { value: $t });
  var pn = f("style,class"),
    dn = f("input,textarea,option,select,progress"),
    vn = function (e, t, n) {
      return (
    ...
    hn = f("contenteditable,draggable,spellcheck"),
    mn = f("events,caret,typing,plaintext-only"),
    yn = function (e, t) {
      return wn(t) || "false" === t ? "false" : "contenteditable" === e && mn(t) ? t : "true";
    },
    gn = f(
  ...
  function xn(e) {
    for (var t = e.data, r = e, i = e; n(i.componentInstance); )
      (i = i.componentInstance._vnode) && i.data && (t = An(i.data, t));
    for (; n((r = r.parent)); ) r && r.data && (t = An(t, r.data));
    return (function (e, t) {
      if (n(e) || n(t)) return kn(e, On(t));
      return "";
    })(t.staticClass, t.class);
  }
  function An(e, t) {
    return { staticClass: kn(e.staticClass, t.staticClass), class: n(e.class) ? [e.class, t.class] : t.class };
  }
  function kn(e, t) {
    return e ? (t ? e + " " + t : e) : t || "";
  }
  ...
  var Cn = { svg: "http://www.w3.org/2000/svg", math: "http://www.w3.org/1998/Math/MathML" },
    Sn = f(
  ...
  function Nn(e) {
    return Tn(e) ? "svg" : "math" === e ? "math" : void 0;
  }
  var Dn = Object.create(null);
  var Fn = f("text,number,password,search,email,tel,url");
  function In(e) {
    if ("string" == typeof e) {
  ...
  var Mn = Object.freeze({
      ...
      createElementNS: function (e, t) {
        return document.createElementNS(Cn[e], t);
      },
  ...
  function Hn(e, r) {
    return (
      ...
      ((e.tag === r.tag &&
        ...
        (!0 === e.isAsyncPlaceholder && e.asyncFactory === r.asyncFactory && t(r.asyncFactory.error)))
    );
  }
  function Un(e, t, r) {
    var i,
      ...
      (function (e, t) {
        ...
        l.length &&
          Ye(t, "postpatch", function () {
            for (var n = 0; n < l.length; n++) qn(l[n], "componentUpdated", t, e);
          });
  ...
  function Kn(e, t) {
    ...
    for (n = 0; n < e.length; n++)
      (r = e[n]).modifiers || (r.modifiers = Vn), (i[Jn(r)] = r), (r.def = Se(t.$options, "directives", r.name));
    return i;
  }
  function Jn(e) {
  ...
  function Wn(e, r) {
    ...
    if (!((n(i) && !1 === i.Ctor.options.inheritAttrs) || (t(e.data.attrs) && t(r.data.attrs)))) {
      var o,
        ...
        c = e.data.attrs || {},
        u = r.data.attrs || {};
      for (o in (n(u.__ob__) && (u = r.data.attrs = k({}, u)), u)) (a = u[o]), c[o] !== a && Gn(s, o, a);
      for (o in c) t(u[o]) && (bn(o) ? s.removeAttributeNS(_n, $n(o)) : hn(o) || s.removeAttribute(o));
    }
  }
  function Gn(e, t, n) {
    e.tagName.indexOf("-") > -1
      ...
      : hn(t)
      ? e.setAttribute(t, yn(t, n))
      : bn(t)
      ? wn(n)
        ? e.removeAttributeNS(_n, $n(t))
        : e.setAttributeNS(_n, t, n)
      : Yn(e, t, n);
  }
  function Yn(e, t, n) {
    wn(n) ? e.removeAttribute(t) : e.setAttribute(t, n);
  }
  var Qn = { create: Wn, update: Wn };
  function Xn(e, n) {
    var r = n.elm,
      i = n.data,
      o = e.data;
  ...
  function ur(e, t, n, r, i) {
    (e.props || (e.props = [])).push(yr({ name: t, value: n, dynamic: i }, r)), (e.plain = !1);
  }
  function lr(e, t, n, r, i) {
    (i ? e.dynamicAttrs || (e.dynamicAttrs = []) : e.attrs || (e.attrs = [])).push(
      yr({ name: t, value: n, dynamic: i }, r)
    ),
      (e.plain = !1);
  }
  function fr(e, t, n, r) {
    (e.attrsMap[t] = n), e.attrsList.push(yr({ name: t, value: n }, r));
  }
  function pr(e, t, n, r, i, o, a, s) {
    (e.directives || (e.directives = [])).push(
      yr({ name: t, rawName: n, value: r, arg: i, isDynamicArg: o, modifiers: a }, s)
    ),
      (e.plain = !1);
  }
  function dr(e, t, n) {
  ...
  function vr(t, n, r, i, o, a, s, c) {
    ...
    var l = yr({ value: r.trim(), dynamic: c }, s);
    i !== e && (l.modifiers = i);
    var f = u[n];
  ...
  function _r(e, t) {
    var n = (function (e) {
      if (((e = e.trim()), (er = e.length), e.indexOf("[") < 0 || e.lastIndexOf("]") < er - 1))
        return (rr = e.lastIndexOf(".")) > -1
          ? { exp: e.slice(0, rr), key: '"' + e.slice(rr + 1) + '"' }
          : { exp: e, key: null };
      (tr = e), (rr = ir = or = 0);
      for (; !$r(); ) wr((nr = br())) ? Ar(nr) : 91 === nr && xr(nr);
      return { exp: e.slice(0, ir), key: e.slice(ir + 1, or) };
    })(e);
    return null === n.key ? e + "=" + t : "$set(" + n.exp + ", " + n.key + ", " + t + ")";
  }
  function br() {
    return tr.charCodeAt(++rr);
  }
  function $r() {
    return rr >= er;
  }
  ...
  function jr(e, t, n, r) {
    ...
    kr.addEventListener(e, t, z ? { capture: n, passive: r } : n);
  }
  function Nr(e, t, n, r) {
  ...
  function Dr(e, r) {
    if (!t(e.data.on) || !t(r.data.on)) {
      ...
      (kr = r.elm),
        (function (e) {
          n(e[Or]) && ((e.input = [].concat(e[Or], e.input || [])), delete e[Or]);
          n(e[Cr]) && ((e.change = [].concat(e[Cr], e.change || [])), delete e[Cr]);
        })(i),
        Ge(i, o, jr, Nr, Sr, r.context),
        (kr = void 0);
    }
  }
  ...
  function Ir(e, r) {
    if (!t(e.data.domProps) || !t(r.data.domProps)) {
      var i,
        ...
        s = e.data.domProps || {},
        c = r.data.domProps || {};
      for (i in (n(c.__ob__) && (c = r.data.domProps = k({}, c)), s)) i in c || (a[i] = "");
      for (i in c) {
  ...
  var Mr = { create: Ir, update: Ir },
    Pr = y(function (e) {
      for (var t = {}, n = /:(.+)/, r = e.split(/;(?![^(]*\))/g), i = 0; i < r.length; i++) {
        var o = r[i];
        if (o) {
          var a = o.split(n);
  ...
  var Rr,
    ...
    Ur = /\s*!important$/,
    Br = function (e, t, n) {
      if (Hr.test(t)) e.style.setProperty(t, n);
      else if (Ur.test(n)) e.style.setProperty(w(t), n.replace(Ur, ""), "important");
      else {
        var r = Vr(t);
    ...
    zr = ["Webkit", "Moz", "ms"],
    Vr = y(function (e) {
      if (((Rr = Rr || document.createElement("div").style), "filter" !== (e = _(e)) && e in Rr)) return e;
      ...
      var d = (function (e, t) {
        ...
        if (t)
          for (var i = e; i.componentInstance; )
            (i = i.componentInstance._vnode) && i.data && (n = Er(i.data)) && k(r, n);
        (n = Er(e.data)) && k(r, n);
        for (var o = e; (o = o.parent); ) o.data && (n = Er(o.data)) && k(r, n);
        return r;
      })(r, !0);
      for (s in f) t(d[s]) && Br(c, s, "");
      for (s in d) (a = d[s]) !== f[s] && Br(c, s, a);
    }
  }
  var Jr = (function (e) {
      var i,
      ...
      for (i = 0; i < Rn.length; ++i)
        for (a[Rn[i]] = [], o = 0; o < s.length; ++o) n(s[o][Rn[i]]) && a[Rn[i]].push(s[o][Rn[i]]);
      function u(e) {
      ...
      function l(e, t, r, i, o, a, s) {
        if (
          (n(e.elm) && n(a) && (e = a[s] = ce(e)),
          (e.isRootInsert = !o),
          !(function (e, t, r, i) {
            var o = e.data;
            if (n(o) && (n((o = o.hook)) && n((o = o.init)) && o(e, !1), n(e.componentInstance)))
              return p(e, t), d(r, e.elm, i), !0;
          })(e, t, r, i))
        ) {
          var u = e.data,
            l = e.children,
            f = e.tag;
          n(f)
            ? ((e.elm = e.ns ? c.createElementNS(e.ns, f) : c.createElement(f, e)),
              y(e),
              v(e, l, t),
              n(u) && m(e, t),
              d(r, e.elm, i))
            : !0 === e.isComment
            ? ((e.elm = c.createComment(e.text)), d(r, e.elm, i))
            : ((e.elm = c.createTextNode(e.text)), d(r, e.elm, i));
        }
      }
      function p(e, t) {
        n(e.data.pendingInsert) && (t.push.apply(t, e.data.pendingInsert), (e.data.pendingInsert = null)),
          (e.elm = e.componentInstance.$el),
          h(e) ? (m(e, t), y(e)) : (En(e), t.push(e));
      }
      function d(e, t, r) {
        n(e) && (n(r) ? c.parentNode(r) === e && c.insertBefore(e, t, r) : c.appendChild(e, t));
      }
      function v(e, t, n) {
        if (Array.isArray(t)) for (var i = 0; i < t.length; ++i) l(t[i], n, e.elm, null, !0, t, i);
      ...
      function m(e, t) {
        for (var r = 0; r < a.create.length; ++r) a.create[r](Ln, e);
        n((i = e.data.hook)) && (n(i.create) && i.create(Ln, e), n(i.insert) && t.push(e));
      }
      function y(e) {
        var t;
        if (n((t = e.fnScopeId))) c.setStyleScope(e.elm, t);
          ...
          for (var r = e; r; )
            n((t = r.context)) && n((t = t.$options._scopeId)) && c.setStyleScope(e.elm, t), (r = r.parent);
        n((t = Lt)) &&
          t !== e.context &&
          t !== e.fnContext &&
      ...
      function _(e) {
        var t,
          r,
          i = e.data;
        if (n(i)) for (n((t = i.hook)) && n((t = t.destroy)) && t(e), t = 0; t < a.destroy.length; ++t) a.destroy[t](e);
        if (n((t = e.children))) for (r = 0; r < e.children.length; ++r) _(e.children[r]);
      }
      function b(e, t, r, i) {
        for (; r <= i; ++r) {
          var o = t[r];
          n(o) && (n(o.tag) ? ($(o), _(o)) : u(o.elm));
        }
      }
      function $(e, t) {
        if (n(t) || n(e.data)) {
          ...
          for (
            n(t)
              ...
              n((r = e.componentInstance)) && n((r = r._vnode)) && n(r.data) && $(r, t),
              r = 0;
            r < a.remove.length;
            ++r
          )
      ...
      function w(e, t, r, i) {
        for (var o = r; o < i; o++) {
          var a = t[o];
          if (n(a) && Hn(e, a)) return o;
        }
      }
      function x(e, r, i, o, s, u) {
        if (e !== r) {
          n(r.elm) && n(o) && (r = o[s] = ce(r));
          var f = (r.elm = e.elm);
          if (!0 !== e.isAsyncPlaceholder)
            if (!0 !== r.isStatic || !0 !== e.isStatic || r.key !== e.key || (!0 !== r.isCloned && !0 !== r.isOnce)) {
              var p,
                d = r.data;
              n(d) && n((p = d.hook)) && n((p = p.prepatch)) && p(e, r);
              var v = e.children,
                m = r.children;
              if (n(d) && h(r)) {
                for (p = 0; p < a.update.length; ++p) a.update[p](e, r);
                n((p = d.hook)) && n((p = p.update)) && p(e, r);
              }
              t(r.text)
                ? n(v) && n(m)
                  ? v !== m &&
                    (function (e, r, i, o, a) {
                      for (
                        ...
                        t(h)
                          ...
                          ? (m = r[--v])
                          : Hn(h, _)
                          ? (x(h, _, o, i, d), (h = r[++p]), (_ = i[++d]))
                          : Hn(m, $)
                          ? (x(m, $, o, i, y), (m = r[--v]), ($ = i[--y]))
                          : Hn(h, $)
                          ? (x(h, $, o, i, y),
                            A && c.insertBefore(e, h.elm, c.nextSibling(m.elm)),
                            (h = r[++p]),
                            ($ = i[--y]))
                          : Hn(m, _)
                          ? (x(m, _, o, i, d), A && c.insertBefore(e, m.elm, h.elm), (m = r[--v]), (_ = i[++d]))
                          : (t(s) && (s = Un(r, p, v)),
                            t((u = n(_.key) ? s[_.key] : w(_, r, p, v)))
                              ? l(_, o, e, h.elm, !1, i, d)
                              : Hn((f = r[u]), _)
                              ? (x(f, _, o, i, d), (r[u] = void 0), A && c.insertBefore(e, f.elm, h.elm))
                              : l(_, o, e, h.elm, !1, i, d),
                            (_ = i[++d]));
                      p > v ? g(e, t(i[y + 1]) ? null : i[y + 1].elm, i, d, y, o) : d > y && b(0, r, p, v);
                    })(f, v, m, i, u)
                  : n(m)
                  ? (n(e.text) && c.setTextContent(f, ""), g(f, null, m, 0, m.length - 1, i))
                  : n(v)
                  ? b(0, v, 0, v.length - 1)
                  : n(e.text) && c.setTextContent(f, "")
                : e.text !== r.text && c.setTextContent(f, r.text),
                n(d) && n((p = d.hook)) && n((p = p.postpatch)) && p(e, r);
            } else r.componentInstance = e.componentInstance;
          else n(r.asyncFactory.resolved) ? O(e.elm, r, i) : (r.isAsyncPlaceholder = !0);
        }
      }
      function A(e, t, r) {
        if (!0 === r && n(e.parent)) e.parent.data.pendingInsert = t;
        else for (var i = 0; i < t.length; ++i) t[i].data.hook.insert(t[i]);
      }
      var k = f("attrs,class,staticClass,staticStyle,key");
      function O(e, t, r, i) {
        var o,
          a = t.tag,
          s = t.data,
          c = t.children;
        if (((i = i || (s && s.pre)), (t.elm = e), !0 === t.isComment && n(t.asyncFactory)))
          return (t.isAsyncPlaceholder = !0), !0;
        if (n(s) && (n((o = s.hook)) && n((o = o.init)) && o(t, !0), n((o = t.componentInstance)))) return p(t, r), !0;
        if (n(a)) {
          if (n(c))
            if (e.hasChildNodes())
              if (n((o = s)) && n((o = o.domProps)) && n((o = o.innerHTML))) {
      ...
      return function (e, r, i, o) {
        if (!t(r)) {
          ...
          if (t(e)) (u = !0), l(r, f);
            ...
            var p = void 0 !== e.nodeType;
            if (!p && Hn(e, r)) x(e, r, f, null, null, o);
            else {
              if (p) {
                if ((1 === e.nodeType && e.hasAttribute(W) && (e.removeAttribute(W), (i = !0)), !0 === i && O(e, r, f)))
                  return A(r, f, !0), e;
                (s = e), (e = new ie(c.tagName(s).toLowerCase(), {}, [], void 0, s));
              }
              var d = e.elm,
                v = c.parentNode(d);
              if ((l(r, f, d._leaveCb ? null : v, c.nextSibling(d)), n(r.parent)))
                for (var m = r.parent, y = h(r); m; ) {
                  for (var g = 0; g < a.destroy.length; ++g) a.destroy[g](m);
                  if (((m.elm = r.elm), y)) {
                    for (var $ = 0; $ < a.create.length; ++$) a.create[$](Ln, m);
                    var w = m.data.hook.insert;
                    if (w.merged) for (var k = 1; k < w.fns.length; k++) w.fns[k]();
                  } else En(m);
                  m = m.parent;
                }
              n(v) ? b(0, [e], 0, 0) : n(e.tag) && _(e);
            }
          }
          return A(r, f, u), r.elm;
        }
        n(e) && _(e);
      };
    })({ nodeOps: Mn, modules: [Qn, ar, Fr, Mr, { create: Kr, update: Kr }].concat(Zn) }),
    qr = {
      inserted: function (e, t, n, r) {
        "select" === n.tag
          ...
          : ("textarea" === n.tag || Fn(e.type)) &&
            ...
            t.modifiers.lazy ||
              (e.addEventListener("compositionstart", Yr),
              e.addEventListener("compositionend", Qr),
        ...
        if ("select" === n.tag) {
          ...
          if (
            ...
            (e.multiple
              ...
              : t.value !== t.oldValue && Wr(t.value, i)) && Xr(e, "change");
        }
      }
    };
  function Zr(e, t, n) {
    !(function (e, t, n) {
      ...
      for (var s = 0, c = e.options.length; s < c; s++)
        if (((i = e.options[s]), a)) (r = j(o, Gr(i)) > -1), i.selected !== r && (i.selected = r);
        else if (T(Gr(i), o)) return void (e.selectedIndex !== s && (e.selectedIndex = s));
      a || (e.selectedIndex = -1);
    })(e, t);
  }
  function Wr(e, t) {
  ...
  var ei = { model: qr };
  (ln.config.mustUseProp = vn),
    (ln.config.isReservedTag = jn),
    (ln.config.isReservedAttr = pn),
    (ln.config.getTagNamespace = Nn),
    (ln.config.isUnknownElement = function (e) {
      ...
      return e.indexOf("-") > -1
        ? (Dn[e] = t.constructor === window.HTMLUnknownElement || t.constructor === window.HTMLElement)
        : (Dn[e] = /HTMLUnknownElement/.test(t.toString()));
    }),
    k(ln.options.directives, ei),
    (ln.prototype.__patch__ = E ? Jr : C),
      ...
      return (function (e, t, n) {
        ...
        return (
          ...
          new Qt(
            ...
            {
              before: function () {
                e._isMounted && !e._isDestroyed && Ht(e, "beforeUpdate");
              }
            },
            !0
          ),
          (n = !1),
          null == e.$vnode && ((e._isMounted = !0), Ht(e, "mounted")),
          e
        );
      })(this, (e = e && E ? In(e) : void 0), t);
    });
  var ti = /\{\{((?:.|\r?\n)+?)\}\}|\{\@((?:.|\r?\n)+?)\@\}/g,
    ni = /[-.*+?^${}()|[\]\/\\]/g,
    ri = y(function (e) {
  ...
  var oi,
    ...
    si = function (e) {
      return ((oi = oi || document.createElement("div")).innerHTML = e), oi.textContent;
    },
    ci = f("area,base,br,col,embed,frame,hr,img,input,isindex,keygen,link,meta,param,source,track,wbr"),
    ui = f("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr,source"),
    li = f(
      "address,article,aside,base,blockquote,body,caption,col,colgroup,dd,details,dialog,div,dl,dt,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,html,legend,li,menuitem,meta,optgroup,option,param,rp,rt,source,style,summary,tbody,td,tfoot,th,thead,title,tr,track"
    ),
    fi = /^\s*([^\s"'<>\/=]+)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,
    pi = /^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,
    di = "[a-zA-Z_][\\-\\.0-9_a-zA-Z" + D.source + "]*",
    vi = "((?:" + di + "\\:)?" + di + ")",
    hi = new RegExp("^<" + vi),
    mi = /^\s*(\/?)>/,
    yi = new RegExp("^<\\/" + vi + "[^>]*>"),
    ...
    _i = /^<!\--/,
    bi = /^<!\[/,
    $i = f("script,style,textarea", !0),
    wi = {},
    xi = { "&lt;": "<", "&gt;": ">", "&quot;": '"', "&amp;": "&", "&#10;": "\n", "&#9;": "\t", "&#39;": "'" },
    Ai = /&(?:lt|gt|quot|amp|#39);/g,
    ki = /&(?:lt|gt|quot|amp|#39|#10|#9);/g,
    Oi = f("pre,textarea", !0),
    Ci = function (e, t) {
      return e && Oi(e) && "\n" === t[0];
    };
  ...
  function Yi(e, t) {
    (Ti = t.warn || sr), (Ii = t.isPreTag || S), (Mi = t.mustUseProp || S), (Pi = t.getTagNamespace || S);
    t.isReservedTag;
    (Ni = cr(t.modules, "transformNode")),
      (Di = cr(t.modules, "preTransformNode")),
    ...
    function u(e) {
      if (
        (l(e),
        s || e.processed || (e = Qi(e, t)),
        i.length || e === n || (n.if && (e.elseif || e.else) && eo(n, { exp: e.elseif, block: e })),
        r && !e.forbidden)
      )
        if (e.elseif || e.else)
          (a = e),
      ...
      (e.children = e.children.filter(function (e) {
        ...
        e.pre && (s = !1),
        Ii(e.tag) && (c = !1);
      for (var f = 0; f < Fi.length; f++) Fi[f](e, t);
    }
    function l(e) {
      ...
      (function (e, t) {
        for (var n, r, i = [], o = t.expectHTML, a = t.isUnaryTag || S, s = t.canBeLeftOpenTag || S, c = 0; e; ) {
          if (((n = e), r && $i(r))) {
            var u = 0,
              l = r,
              f = wi[l] || (wi[l] = new RegExp("([\\s\\S]*?)(</" + l + "[^>]*>)", "i")),
              p = e.replace(f, function (e, n, r) {
                return (
                  (u = r.length),
                  $i(l) || (n = n.replace(/<!\--([\s\S]*?)-->/g, "$1").replace(/<!\[CDATA\[([\s\S]*?)]]>/g, "$1")),
                  Ci(l, n) && (n = n.slice(1)),
                  t.chars && t.chars(n),
                  ""
                );
            ...
            if (d >= 0) {
              for (
                $ = e.slice(d);
                !(yi.test($) || hi.test($) || _i.test($) || bi.test($) || (w = $.indexOf("<", 1)) < 0);
        ...
        function A() {
          ...
          if (t) {
            ...
            for (x(t[0].length); !(n = e.match(mi)) && (r = e.match(pi) || e.match(fi)); )
        ...
        function k(e) {
          var n = e.tagName,
            c = e.unarySlash;
          o && ("p" === r && li(n) && O(r), s(n) && r === n && O(n));
          for (var u = a(n) || !!c, l = e.attrs.length, f = new Array(l), p = 0; p < l; p++) {
            var d = e.attrs[p],
              v = d[3] || d[4] || d[5] || "",
              h = "a" === n && "href" === d[1] ? t.shouldDecodeNewlinesForHref : t.shouldDecodeNewlines;
            f[p] = { name: d[1], value: Si(v, h) };
          }
          u || (i.push({ tag: n, lowerCasedTag: n, attrs: f, start: e.start, end: e.end }), (r = n)),
            t.start && t.start(n, f, u, e.start, e.end);
        }
        function O(e, n, o) {
          var a, s;
          if ((null == n && (n = c), null == o && (o = c), e))
            for (s = e, a = i.length - 1; a >= 0 && i[a].lowerCasedTag !== s; a--);
          else a = 0;
          if (a >= 0) {
        ...
        start: function (e, o, a, l, f) {
          ...
          d && (v.ns = d),
            ("style" !== (p = v).tag &&
              ...
              K() ||
              (v.forbidden = !0);
          for (var h = 0; h < Di.length; h++) v = Di[h](v, t) || v;
          s ||
            (!(function (e) {
        ...
        chars: function (e, t, n) {
          if (r) {
            ...
            if (
              ...
              c || "condense" !== a || (e = e.replace(qi, " ")),
                !s &&
                " " !== e &&
                (u = (function (e, t) {
                  var n = t ? ri(t) : ti;
                  if (n.test(e)) {
                    for (var r, i, o, a = [], s = [], c = (n.lastIndex = 0), u = !1; (r = n.exec(e)); ) {
                      (i = r.index) > c && (s.push((o = e.slice(c, i))), a.push(JSON.stringify(o)));
                      var l = r[2];
                      if (l) a.push({ exp: l.trim() }), (u = !0);
                      else {
                        var f = r[1].trim();
                        a.push("_s(" + f + ")"), s.push({ "@binding": f });
                      }
                      c = i + r[0].length;
                    }
                    return (
                      c < e.length && (s.push((o = e.slice(c))), a.push(JSON.stringify(o))),
                      { expression: a, tokens: s, hasChildExp: u }
                    );
                  }
                })(e, ji))
                  ? (l = { type: 2, expression: u.expression, tokens: u.tokens, hasChildExp: u.hasChildExp, text: e })
  ...
  function Qi(e, t) {
    ...
    (r = hr((n = e), "key")) && (n.key = r),
      ...
      (function (e) {
        var t;
        "template" === e.tag
          ? ((t = mr(e, "scope")), (e.slotScope = t || mr(e, "slot-scope")))
          : (t = mr(e, "slot-scope")) && (e.slotScope = t);
        var n = hr(e, "slot");
        n &&
      ...
      (function (e) {
        "slot" === e.tag && (e.slotName = hr(e, "name"));
      })(e),
      (function (e) {
        var t;
    ...
    for (var i = 0; i < Ni.length; i++) e = Ni[i](e, t) || e;
    return (
      (function (e) {
        var t,
          n,
        ...
        for (t = 0, n = u.length; t < n; t++)
          if (((r = i = u[t].name), (o = u[t].value), Li.test(r)))
            if (((e.hasBindings = !0), (a = to(r.replace(Li, ""))) && (r = r.replace(Ki, "")), Vi.test(r)))
              (r = r.replace(Vi, "")),
                (c = Bi.test(r)) && (r = r.slice(1, -1)),
                a &&
                  (a.prop && !c && "innerHtml" === (r = _(r)) && (r = "innerHTML"),
                  a.camel && !c && (r = _(r)),
                  a.sync &&
                    ((s = _r(o, "$event")),
                    c
                      ? vr(e, '"update:"+(' + r + ")", s, null, !1, 0, u[t], !0)
                      : (vr(e, "update:" + _(r), s, null, !1, 0, u[t]),
                        w(r) !== _(r) && vr(e, "update:" + w(r), s, null, !1, 0, u[t])))),
                (a && a.prop) || (!e.component && Mi(e.tag, e.attrsMap.type, r))
                  ? ur(e, r, o, u[t], c)
                  : lr(e, r, o, u[t], c);
            else if (Ei.test(r))
              (r = r.replace(Ei, "")), (c = Bi.test(r)) && (r = r.slice(1, -1)), vr(e, r, o, a, !1, 0, u[t], c);
            else {
              var l = (r = r.replace(Li, "")).match(zi),
                f = l && l[1];
              (c = !1),
                f && ((r = r.slice(0, -(f.length + 1))), Bi.test(f) && ((f = f.slice(1, -1)), (c = !0))),
                pr(e, r, i, o, f, c, a, u[t]);
            }
          else
            lr(e, r, JSON.stringify(o), u[t]),
              !e.component && "muted" === r && Mi(e.tag, e.attrsMap.type, r) && ur(e, r, "true", u[t]);
      })(e),
      e
    );
  }
  function Xi(e) {
    ...
    if ((t = mr(e, "v-for"))) {
      var n = (function (e) {
        ...
        var n = {};
        n.for = t[2].trim();
        var r = t[1].trim().replace(Ui, ""),
          i = r.match(Hi);
        i
          ? ((n.alias = r.replace(Hi, "").trim()), (n.iterator1 = i[1].trim()), i[2] && (n.iterator2 = i[2].trim()))
          : (n.alias = r);
        return n;
      })(t);
      n && k(e, n);
  ...
  function to(e) {
    var t = e.match(Ki);
    if (t) {
      for (var n = {}, r = 0; r < t.length; r++) n[t[r].slice(1)] = !0;
      return n;
    }
  }
  function no(e) {
  ...
  function ro(e) {
    return Gi(e.tag, e.attrsList.slice(), e.parent);
  }
  var io = [
    ii,
    ai,
      ...
      preTransformNode: function (e, t) {
        if ("input" === e.tag) {
          ...
          if (
            ...
            var u = ro(e);
            mr(u, "v-for", !0), fr(u, "type", "radio"), Qi(u, t), eo(c, { exp: "(" + n + ")==='radio'" + o, block: u });
            var l = ro(e);
            return (
              mr(l, "v-for", !0),
              fr(l, ":type", n),
    ...
    so = {
      ...
      directives: {
        model: function (e, t, n) {
          ...
          if ("select" === o)
            !(function (e, t, n) {
              var r =
                ...
                "});";
              (r = r + " " + _r(t, "$event.target.multiple ? $$selectedVal : $$selectedVal[0]")),
              ...
              ur(
                ...
                vr(
                  ...
                  "var $$a=" +
                    ...
                    _r(t, "$$a.concat([$$v])") +
                    ")}else{$$i>-1&&(" +
                    _r(t, "$$a.slice(0,$$i).concat($$a.slice($$i+1))") +
                    ")}}else{" +
                    _r(t, "$$c") +
                    "}",
                  null,
            ...
            !(function (e, t, n) {
              var r = n && n.number,
                i = hr(e, "value") || "null";
              ur(e, "checked", "_q(" + t + "," + (i = r ? "_n(" + i + ")" : i) + ")"),
                vr(e, "change", _r(t, i), null, !0);
            })(e, r, i);
          ...
          else if (!Q.isReservedTag(o)) return gr(e, r, i), !1;
          return !0;
        },
        text: function (e, t) {
          t.value && ur(e, "textContent", "_s(" + t.value + ")", t);
        },
        html: function (e, t) {
          t.value && ur(e, "innerHTML", "_s(" + t.value + ")", t);
        }
      },
      isPreTag: function (e) {
        return "pre" === e;
  ...
  var lo = /^([\w$_]+|\([^)]*?\))\s*=>|^function\s*(?:[\w$]+)?\s*\(/,
    ...
    vo = { esc: 27, tab: 9, enter: 13, space: 32, up: 38, left: 37, right: 39, down: 40, delete: [8, 46] },
    ho = {
      esc: ["Esc", "Escape"],
      tab: "Tab",
      enter: "Enter",
  ...
  function _o(e) {
    ...
    var t = po.test(e.value),
      n = lo.test(e.value),
      r = po.test(e.value.replace(fo, ""));
    if (e.modifiers) {
      var i = "",
        o = "",
        a = [];
      for (var s in e.modifiers)
        if (yo[s]) (o += yo[s]), vo[s] && a.push(s);
        else if ("exact" === s) {
          var c = e.modifiers;
          o += mo(
            ["ctrl", "shift", "alt", "meta"]
      ...
      return (
        a.length &&
          (i += (function (e) {
            return "if(!$event.type.indexOf('key')&&" + e.map(bo).join("&&") + ")return null;";
          })(a)),
        o && (i += o),
        "function($event){" +
          i +
  ...
  var $o = {
    ...
    wo = function (e) {
      (this.options = e),
        ...
        (this.directives = k(k({}, $o), e.directives));
  ...
  function xo(e, t) {
    var n = new wo(t);
    return { render: "with(this){return " + (e ? Ao(e, n) : '_c("div")') + "}", staticRenderFns: n.staticRenderFns };
  }
  function Ao(e, t) {
    if ((e.parent && (e.pre = e.pre || e.parent.pre), e.staticRoot && !e.staticProcessed)) return ko(e, t);
    if (e.once && !e.onceProcessed) return Oo(e, t);
    if (e.for && !e.forProcessed) return So(e, t);
    if (e.if && !e.ifProcessed) return Co(e, t);
    if ("template" !== e.tag || e.slotTarget || t.pre) {
      ...
      if (e.component)
        n = (function (e, t, n) {
          var r = t.inlineTemplate ? null : Do(t, n, !0);
          return "_c(" + e + "," + To(t, n) + (r ? "," + r : "") + ")";
        })(e.component, e, t);
      else {
        var r;
        (!e.plain || (e.pre && t.maybeComponent(e))) && (r = To(e, t));
        var i = e.inlineTemplate ? null : Do(e, t, !0);
        n = "_c('" + e.tag + "'" + (r ? "," + r : "") + (i ? "," + i : "") + ")";
      }
      for (var o = 0; o < t.transforms.length; o++) n = t.transforms[o](e, n);
      return n;
    }
    return Do(e, t) || "void 0";
  }
  function ko(e, t) {
    e.staticProcessed = !0;
    var n = t.pre;
    return (
      e.pre && (t.pre = e.pre),
      t.staticRenderFns.push("with(this){return " + Ao(e, t) + "}"),
      (t.pre = n),
      "_m(" + (t.staticRenderFns.length - 1) + (e.staticInFor ? ",true" : "") + ")"
    );
  }
  function Oo(e, t) {
    if (((e.onceProcessed = !0), e.if && !e.ifProcessed)) return Co(e, t);
    if (e.staticInFor) {
      ...
      return n ? "_o(" + Ao(e, t) + "," + t.onceId++ + "," + n + ")" : Ao(e, t);
    }
    return ko(e, t);
  }
  function Co(e, t, n, r) {
    return (
      ...
      (function e(t, n, r, i) {
        ...
        function a(e) {
          return r ? r(e, n) : e.once ? Oo(e, n) : Ao(e, n);
        }
  ...
  function So(e, t, n, r) {
    ...
    return (
      (e.forProcessed = !0), (r || "_l") + "((" + i + "),function(" + o + a + s + "){return " + (n || Ao)(e, t) + "})"
    );
  }
  function To(e, t) {
    var n = "{",
          ...
          (function (e, t, n) {
            var r =
                ...
                Object.keys(t).some(function (e) {
                  var n = t[e];
                  return n.slotTargetDynamic || n.if || n.for || jo(n);
                }),
              i = !!e.if;
            if (!r)
              for (var o = e.parent; o; ) {
                if ((o.slotScope && o.slotScope !== Wi) || o.for) {
                  r = !0;
                  break;
                }
                o.if && (i = !0), (o = o.parent);
  ...
  function jo(e) {
    return 1 === e.type && ("slot" === e.tag || e.children.some(jo));
  }
  function No(e, t) {
    var n = e.attrsMap["slot-scope"];
    if (e.if && !e.ifProcessed && !n) return Co(e, t, No, "null");
    if (e.for && !e.forProcessed) return So(e, t, No);
    var r = e.slotScope === Wi ? "" : String(e.slotScope),
      i =
        "function(" +
        r +
        "){return " +
        ("template" === e.tag
          ? e.if && n
            ? "(" + e.if + ")?" + (Do(e, t) || "undefined") + ":undefined"
            : Do(e, t) || "undefined"
          : Ao(e, t)) +
        "}",
      o = r ? "" : ",proxy:true";
          ...
          if (2 === e.type) {
            if (e.hasChildExp) {
              for (var n = [], r = [], i = 0; i < t.length; i++) {
                var o = t[i];
                o.exp ? (r.length && (n.push("_v(" + r.join("+") + ")"), (r = [])), n.push(o.exp)) : r.push(o);
              }
              return r.length && n.push("_v(" + r.join("+") + ")"), n.join(",");
            }
            return "_v(" + t.join("+") + ")";
          }
          return "_v(" + (2 === e.type ? t.join("+") : Po(JSON.stringify(e.text))) + ")";
        })(e);
  }
  function Mo(e) {
  ...
  var Ro,
    ...
    function (e) {
      ...
      return { compile: t, compileToFunctions: Lo(t) };
    })(so).compileToFunctions;
  function Bo(e) {
    return (
      ((Ho = Ho || document.createElement("div")).innerHTML = e ? '<a href="\n"/>' : '<div a="\n"/>'),
  ...
  var zo = !!E && Bo(!1),
    ...
    Jo = ln.prototype.$mount;
  return (
    (ln.prototype.$mount = function (e, t) {
      if ((e = e && In(e)) === document.body || e === document.documentElement) return this;
      var n = this.$options;
      if (!n.render) {
        var r = n.template;
        if (r)
...
!(function () {
  var e = usf.settings,
    t = usf.event,
    s = usf.templates,
    i = e["translation_" + usf.platform.locale];
  if (!i)
    for (var r in e)
      if (r.startsWith("translation")) {
        i = e[r];
        break;
      }
  e.translation = i;
  ...
  function p(e, t, s) {
    var i = $r.getBaseType(e);
    if (i) {
      if (s) {
        var r = i[s][t],
          a = i.mixins;
        if (!r && a) for (var o = 0; o < a.length; o++) if ((r = a[o][s]) && (r = r[t])) return r;
        return r;
      }
      return i[t];
    }
  ...
  Object.assign(window.usf, {
    register: function (e, t, s) {
      ...
      if (
        ...
        for (var r in ((i.__baseType = t),
        ["methods", "props", "computed", "events", "model", "data", "watch", "inject", "provide"].forEach((e) =>
          m(i, t, e)
        ),
        t.mixins && (i.mixins || (i.mixins = []), h(i.mixins, t.mixins)),
        t)) {
          var a = t[r];
          !i[r] && u.includes(r) && (i[r] = a);
        }
      return s && RVue.component(s, i), i;
    },
    base: function (e, t, s, i, r) {
      var a = p(t, s, r);
      if (!a) throw new Error("Base method named '" + s + "' not found.");
      return i ? a.apply(e, i) : a.apply(e);
    }
  });
  var g = {
    props: { value: String, options: Array, placeholder: String },
    data: () => ({ show: !1 }),
    methods: {
      onInput(e) {
        a.stopEvent(e), this.onClose(), this.$emit("input", e.target.getAttribute("data-value"));
      },
      onToggle(e) {
        if ((a.stopEvent(e), !this.show)) {
          var t = this.$refs.p;
          usf.isMobile ? document.body.appendChild(t) : this.$el.appendChild(t);
        }
        setTimeout(() => {
          var e = (this.show = !this.show);
          document.body.classList[e ? "add" : "remove"]("usf-has-popup"),
            document.body[e ? "addEventListener" : "removeEventListener"]("mousedown", this.onClose);
        }, 0);
      },
      onClose(e) {
        if (e) {
          var t = e.target;
          if (t.closest(".usf-c-select") && !t.classList.contains("usf-remove")) return;
        }
        (this.show = !1),
    ...
    render(e) {
      ...
      if (t) {
        var s;
        s = usf.isMobile ? this.placeholder : (s = t.find((e) => e.value == this.value)) ? s.label : this.placeholder;
        for (var i = [], r = 0; r < t.length; r++) {
          var a = t[r];
          i.push(
            e("button", {
              class: { "usf-c-select__btn usf-btn": !0, "usf-selected": this.value === a.value },
              domProps: { innerHTML: a.label },
              on: { click: this.onInput },
              attrs: { "data-value": a.value }
            })
          );
        }
        return e("div", { class: "usf-c-select" + (this.show ? " usf-opened" : "") }, [
          e("button", {
            class: "usf-c-select__input-value usf-btn",
            on: { click: this.onToggle },
            domProps: { innerHTML: s }
          }),
          e("div", { class: "usf-popover", ref: "p", attrs: { "aria-hidden": !this.show } }, [
            e("div", { class: "usf-body" }, [
              usf.isMobile
                ? e("div", { class: "usf-c-select__header" }, [
                    e("div", { class: "usf-remove", on: { click: this.onClose } }),
                    e("span", { class: "", domProps: { innerHTML: this.placeholder } })
                  ])
                : null,
              e("div", { class: "usf-c-select__content" }, [e("div", { class: "usf-c-select__list" }, i)])
            ])
          ])
        ]);
      }
  ...
  usf.components.DropDown = usf.register(g, null, "usf-dropdown");
  var v = {
    props: { value: Boolean, label: String, name: String },
    methods: {
      onInput(e) {
    ...
    render(e) {
      return e("div", { class: "usf-c-checkbox" }, [
        e("div", { class: "usf-c-inner-option" }, [
          e("input", {
        ...
        e("span", { domProps: { innerHTML: this.label } })
      ]);
    }
  };
  usf.components.CheckBox = usf.register(g, null, "usf-checkbox");
  var b = {
      props: { tooltip: String },
      render(e) {
        return e("div", { class: "usf-c-tooltip" }, [
          e("div", { class: "usf-c-tooltip__popup", domProps: { innerHTML: this.tooltip } })
        ]);
      }
    },
    y,
  ...
  function C(e, t) {
    var s,
      i = t.innerSymbols;
    if (i) {
      var r = (Math.log10(e) / 3) | 0;
      if (((s = i[r]), r)) e /= Math.pow(10, 3 * r);
    } else s = "";
    return qe(e, t.decimals) + s;
  }
  function U(e, t, s) {
    return [
      e("span", { class: "usf-slider-pip__value-wrapper" }, [
        s.prefix ? e("span", { class: "usf-slider-pip__prefix" }, [s.prefix]) : null,
        e("span", { class: "usf-slider-pip__value" }, [C(s.converter(t), s)]),
        s.suffix ? e("span", { class: "usf-slider-pip__suffix" }, [s.suffix]) : null
      ])
    ];
  }
  usf.components.HelpTip = usf.register(b, null, "usf-helptip");
  var L = {
    props: {
      value: Array,
      min: Number,
    ...
    data() {
      var e = this.symbols;
      return e && (Array.isArray(e) || (e = ("," + e).split(","))), { dragging: !1, innerSymbols: e };
    },
    methods: {
      onKeyDown(e) {
        var t, s, i;
        switch (e.keyCode) {
          ...
          case 27:
            return (
              (r = e.target === this.$refs.l)
                ? ((s = this.min), (i = this.value[1]))
                : ((s = this.value[0]), (i = this.max)),
              this.$emit("input", [s, i]),
              void this.$emit("change", [s, i])
            );
        }
        if (void 0 !== t) {
          var r = e.target === this.$refs.l,
            a = this.value;
          r
            ? ((s = a[0] + t), (i = a[1]), s < this.min ? (s = this.min) : s > i && (s = i))
            : ((s = a[0]), (i = a[1] + t) < s ? (i = s) : i > this.max && (i = this.max)),
            (s == a[0] && i === a[1]) ||
              (this.$emit("input", [s, i]),
              clearTimeout(this._timeout),
              (this._timeout = setTimeout(() => this.$emit("change", [s, i]), 100)));
        }
      },
      onMouseUp(e) {
        this.$emit("change", [S, x]), (this.dragging = !1), this.clearDrag();
      },
      onMouseMove(e) {
        var t = (e.touches ? e.touches[0].clientX : e.clientX) - y,
          s = this.value[0],
          i = this.value[1],
          r = this.min,
          a = this.max;
        w
          ? ((s = _ + F((t / _width) * (a - r), this.step)) < r && (s = r), s > i && (s = i))
          : ((i = I + F((t / _width) * (a - r), this.step)) > a && (i = a), i < s && (i = s)),
          (S === s && x === i) || ((S = s), (x = i), this.$emit("input", [s, i]));
      },
      onMinMouseDown(e) {
        this.onHandleMouseDown(e, !0);
      },
      onMaxMouseDown(e) {
        this.onHandleMouseDown(e, !1);
      },
      onHandleMouseDown(e, t) {
        if (!this.dragging) {
          var s = e.target;
          (s.style.zIndex = 2),
            (this.$refs[s === this.$refs.l ? "r" : "l"].style.zIndex = 1),
            (this.dragging = !0),
            (y = e.touches ? e.touches[0].clientX : e.clientX),
            (w = t),
            (_width = this.$el.clientWidth),
            (_ = this.value[0]),
            (I = this.value[1]);
          var i = this.onMouseUp,
            r = this.onMouseMove;
          (P = { mouseup: i, mousemove: r, touchend: i, touchmove: r }), a.on(document.body, P, { passive: !0 });
        }
      },
      clearDrag() {
        a.off(document.body, P);
      }
    },
    beforeDestroy() {
      this.clearDrag();
    ...
    render(e) {
      for (
        var t = this.min, s = this.max, i = this.color, r = [], a = s - t, o = a / this.pips, l = 0;
        l < this.pips;
        l++
      ) {
        var n = l * o,
          c = t + n;
        if (
          (r.push(e("div", { style: "left:" + (100 * n) / a + "%", class: "usf-c-slider__pip" }, U(e, c, this))),
          !l && a <= this.step)
        )
          break;
      }
      r.push(e("div", { style: "right:0", class: "usf-c-slider__pip" }, U(e, s, this)));
      var u = this.value[0],
        h = this.value[1];
      u < t && (u = t), u > s && (u = s), h > s && (h = s), h < t && (h = t);
      var d = (100 * (u - t)) / a + "%",
        f = (100 * (h - t)) / a + "%";
      return e("div", { class: "usf-c-slider" }, [
        r,
        e("div", { class: "usf-c-slider__track" }, [
          e("div", { class: "usf-active", style: { left: d, width: (100 * (h - u)) / a + "%", backgroundColor: i } })
        ]),
        e("div", {
          class: "usf-c-slider__handle usf-c-slider__handle-min usf-c",
          ref: "l",
          attrs: { tabindex: 0 },
          style: { left: d, borderColor: i },
          on: { "&mousedown": this.onMinMouseDown, "&touchstart": this.onMinMouseDown, keydown: this.onKeyDown }
        }),
        e("div", {
          class: "usf-c-slider__handle usf-c-slider__handle-max usf-c",
          ref: "r",
          attrs: { tabindex: 0 },
          style: { left: f, borderColor: i },
          on: { "&mousedown": this.onMaxMouseDown, "&touchstart": this.onMaxMouseDown, keydown: this.onKeyDown }
        })
      ]);
    }
  };
  usf.components.Slider = usf.register(L, null, "usf-slider");
  var M = navigator.userAgent,
    T = M.includes("iPad") || M.includes("iPhone"),
    k;
  function N(e, t) {
    var s = 0,
      i = 0,
    ...
    if (t) {
      for (
        ...
        !isNaN(e.offsetLeft) &&
        !isNaN(e.offsetTop) &&
        ((s += e.offsetLeft), (i += e.offsetTop), (e = e.offsetParent) !== t);

      );
      for (
        r = r.parentNode;
        r && !isNaN(r.scrollLeft) && !isNaN(r.scrollTop) && ((s -= r.scrollLeft), (i -= r.scrollTop), r !== t);

      )
        r = r.parentNode;
    } else {
      var a = e.getBoundingClientRect();
      (s = a.x + window.scrollX), (i = a.y + window.scrollY);
    }
    return { x: s, y: i };
  }
  var D = { url: e.resUrl + "no-image.svg", width: 360, height: 260 };
  function R() {
    for (var e = document.head.children, t = 0; t < e.length; t++) {
      var s = e[t];
      if ("SCRIPT" == s.tagName && -1 !== s.text.indexOf("usf-license.js")) return !0;
    }
  }
  Object.assign(usf.platform, {
    get addToCartUrl() {
      return l.baseUrl + "/cart/add";
    },
    get searchUrl() {
      return l.baseUrl + "/search";
    },
    emptyImage: D,
    getProductUrl(e, t, s) {
      var i;
      return (
        (i =
          !l.useProductsUrl && e && "all" !== e && -1 === e.indexOf("/")
            ? l.baseUrl + "/collections/" + e + "/products/" + t.urlName
            : l.baseUrl + "/products/" + t.urlName),
        s && (i += "?variant=" + s.id),
        i
      );
    },
    getImageUrl(t, s) {
      if (!t.includes("shopify.com") || t.includes("/assets/")) return t;
      var i = t.lastIndexOf(".");
      if ("list" === s)
        switch (e.search.imageSizeType) {
          case "fixed":
            s = "_" + e.search.imageSize + "x";
            break;
          default:
            s = "";
        }
      else s = "small" === s ? "_small" : s ? "_" + s + "x" : "";
      return t.substring(0, i) + s + t.substring(i);
    },
    getCollectionUrl(e) {
      if ("number" == typeof e) {
        var t;
        for (var s in usf.collectionsByUrlName) {
          var i = usf.collectionsByUrlName[s];
          if (i.id === e) {
            (e = i), (t = !0);
            break;
          }
      ...
      var r = e.urlName || e;
      return l.baseUrl + "/collections/" + r;
    },
    getPageUrl(e) {
      var t = l.baseUrl;
      switch (e.type) {
        case "Article":
          return t + "/blogs/" + e.urlName;
        case "Page":
          e = e.urlName;
      }
      return t + "/pages/" + e;
    ...
    window.addEventListener("load", function () {
      a.registerScriptsLoadedCallback(
        ...
        8e3,
        function () {
          window._usfActive || R() || l.redirectToOriginalView();
        }
      );
    });
  var O = ["price"],
  ...
  function B(e) {
    ...
    return (
      void 0 !== e.min
        ? ((t = (e.minInclusive ? ":" : "") + e.min + " "),
          e.max < Ee && (t += (e.maxInclusive ? ":" : "") + e.max),
          (t += " " + e.label))
        : (t = e.label),
      t
    );
  ...
  function E(e, t, s, i) {
    var r = t.inStockLabel;
    if (void 0 !== r) {
      var a = t.outOfStockLabel;
      return "1" === e.label ? r : a;
    }
    return e.label || "reviewRating" !== t.facetName
      ? void 0 !== e.min
        ? H(e, t)
        : V(e.llabel || e.label, t)
      : A(e, t.ratingColor);
  }
  function H(t, s) {
    var i = t.min,
      r = t.max,
      a = O.includes(s.facetName);
    return (
      a ? ((i = qe(i * e.currencyRate)), (i = Oe(e.priceFormat, i))) : (i = qe(i)),
      r !== Ee && (a ? ((r = qe(r * e.currencyRate)), (r = Oe(e.priceFormat, r))) : (r = qe(r))),
      Oe(t.label, i, r)
    );
  }
  function q(t, s, i) {
    if (t.numericRange) {
      ...
      if (-1 !== r) {
        var a,
          ...
          l = i.substr(0, r),
          n = i.indexOf(" ", r + 1);
        -1 === n ? (a = i.substr(r + 1)) : ((a = i.substr(r + 1, n - r - 1)), (o = i.substr(n + 1)));
        var c = ":" === l[0],
          u = ":" === a[0];
        (l = Ae(l)), (a = Ae(a));
        var h = O.includes(s),
          d = j(h, t.valueFormula),
          f = d(parseFloat(l)),
          m = a.length ? d(parseFloat(a)) : -1;
        if ("reviewRating" === s && !o) return A({ min: f, minInclusive: c, max: m, maxInclusive: u }, t.ratingColor);
        o ||
          (f < t.min && (l = t.min.toString()),
          m > t.max && (a = t.max.toString()),
          (o = t.rangeFormat || "{0} - {1}"));
        var p,
          g = t.range;
        return (
          g && (p = g[2]),
          h
            ? ((l = Oe(e.priceFormat, qe(f, p))), a && (a = Oe(e.priceFormat, qe(m, p))))
            : ((l = qe(f, p)), a && (a = qe(m, p))),
          Oe(o, l, a)
        );
      }
    } else {
      if (void 0 !== t.inStockLabel) return "1" === i ? t.inStockLabel : t.outOfStockLabel;
      if ("collections" === t.facetName) {
        var v = parseInt(i);
        if (!Number.isNaN(v)) {
          var b = usf.collectionsByUrlName;
          for (var y in b) {
            var w = b[y];
            if (w.id === v) {
              i = w.title;
  ...
  function V(e, t) {
    var s = t.valuesTransformation;
    return s ? '<span class="usf-' + s.toLowerCase() + '">' + e + "</span>" : e;
  }
  function z() {
    setTimeout(() => {
      usf_container.getBoundingClientRect().top <= -50 && a.scrollTo(usf_container.scrollTop, 800);
    }, 100);
  }
  function A(e, t) {
    var s;
    s = e.minInclusive || !e.maxInclusive ? e.min : e.max;
    for (var i = '<span class="usf-stars" style="color:' + t + '">', r = 1; r <= 5; r++)
      i += '<i class="usf-icon usf-icon-star' + (r > s ? "-empty" : "") + '"></i>';
    return (i += "</span>");
  }
  function j(e, t) {
    return t || e
      ? function (s) {
          return e && (s = a.convertPrice(s)), t && (eval("var value=" + s), (s = eval("(" + t + ")"))), s;
        }
      : (e) => e;
  }
  var W = {
    template: s.filtersBreadcrumb,
  ...
  usf.components.FacetFilterBreadcrumb = usf.register(W, null, "usf-filter-breadcrumb");
  var X = {
    props: { facet: Object, terms: Object },
    template: s.filter,
    inject: { root: { default: null } },
    created() {
      var e = this.facet;
      (this.loc = i),
        (this.id = e.id),
        (this.hasLazyLoad = e.maxHeight && !e.maxItems && "List" === e.display && e.labels.length > 24),
        (this.maxItems = this.hasLazyLoad ? 24 : e.maxItems),
        (this.loadedItemsCount = this.maxItems);
    },
    data() {
      this.facet;
      return { loadedItemsCount: this.maxItems };
    },
    computed: {
      rangeConverter() {
        return j(this.isPrice, this.facet.valueFormula);
      },
      rangeResolver() {
        return j(this.isPrice, this.facet.inverseFormula);
      },
      canShow() {
        var e = this.facet;
        return this.isRange ? e.min !== e.max : e.navigationCollections ? this.options.length : e.labels.length;
      },
      rangeDecimals() {
        var e = this.facet.range[2];
      ...
      range() {
        var e = this.facet,
          ...
          i = t,
          r = s,
          a = this.root.facetFilters;
        if (a) {
          var o = a[e.id];
          if (o) {
            var l = (o = o[1])[0].split(" ");
            (i = parseFloat(Ae(l[0]))), (r = parseFloat(Ae(l[1]))), i < t && (i = t), r > s && (r = s);
          }
        }
        return [i, r];
      },
      isRange() {
        var e = this.facet;
        return void 0 !== e.min && "List" !== e.display;
      },
      hasRangeInputs() {
        var e = this.facet;
        return !e.valueFormula || e.inverseFormula;
      },
      isPrice() {
        return O.includes(this.facet.facetName);
      },
      hasSearchBox() {
        var e = this.facet;
        return usf.isMobile ? e.searchBoxOnMobile : e.searchBoxOnPc;
      },
      isInBreadcrumb() {
        var e = this.root.facetFilters;
        return e && e[this.facet.id];
      },
      options() {
        var e,
          t,
          ...
          i = s.sort,
          r = s.labels;
        if (s.navigationCollections) {
          var a = J(s);
          if (a) return a;
        }
        if ((t = s.manualValues)) {
          for (var o = [], l = 0; l < t.length; l++) {
            var n = r.find((e) => e.label === ml);
            n && o.push(n);
          }
          if (!o.length) return;
          (r = o), s.sortManualValues || (i = null);
        } else if ((e = s.excludedValues)) for (l = r.length - 1; l >= 0; l--) e.includes(r[l].label) && r.splice(l, 1);
        null !== i &&
          (r = r.slice(0, r.length)).sort((e, t) => {
            var s = e.label.toLowerCase(),
        ...
        var c = this.term;
        return c && ((c = c.toLowerCase()), (r = r.filter((e) => e.label.toLowerCase().includes(c)))), r;
      },
      visibleOptions() {
        this.facet;
        var e = this.options,
          t = this.maxItems;
        if (t && e.length > t) {
          var s = this.loadedItemsCount;
          s < e.length && (e = e.slice(0, s));
        }
        return e;
      },
      term: {
        get() {
          return this.root.terms[this.id];
        },
        set(e) {
          this.$set(this.root.terms, this.id, e);
        }
      },
      collapsed() {
        var e = this.root,
          t = e.collapsed[this.id];
        return void 0 === t && (t = this.facet.collapseOnPc || e.horz), t;
      },
      isMoreVisible() {
        var e = this.facet,
          t = this.options,
          s = (e.id, e.maxItems);
        return !!(s && t.length > s) && !(this.loadedItemsCount >= t.length) && s;
      }
    },
    mounted() {
      if (this.hasLazyLoad) {
        var e = this.$refs.values;
        usf.isMobile && (e = e.closest(".usf-body")), e && ((this._scrollEl = e), a.on(e, "scroll", this.onScroll));
      }
    },
    beforeDestroy() {
      this._scrollEl && a.off(this._scrollEl, "scroll", this.onScroll);
    },
    methods: {
      onShowMore(e) {
        var t = this.facet;
        (this.loadedItemsCount += t.maxItems),
          this.$nextTick(() => (this.$refs.values.scrollTop = this.$refs.values.scrollHeight)),
          a.stopEvent(e);
      },
      onScroll(e) {
        var t = this._scrollEl,
          s = t.scrollTop + t.offsetHeight;
        if (this.loadedItemsCount < this.options.length && s + 5 > t.scrollHeight) {
          this.loadedItemsCount += this.maxItems;
          var i = t.parentNode.classList;
          i.add("usf-with-loader"),
            setTimeout(function () {
              i.remove("usf-with-loader");
            }, 300);
        }
      },
      onExpandCollapse() {
        var e = this.root,
          t = this.id,
          s = e.collapsed[t];
        void 0 === s && (s = this.collapsed),
          s
            ? (e.horz &&
                (e.facets.forEach((t) => {
                  this.$set(e.collapsed, t.id, 1);
                }),
                $ ||
                  ($ = (t) => {
                    t.target.closest(".usf-facet") ||
                      (e.facets.forEach((t) => {
                        this.$set(e.collapsed, t.id, 1);
                      }),
                      a.off(document, "click", $));
                  }),
                setTimeout(() => a.on(document, "click", $), 400)),
              this.$set(e.collapsed, t, 0))
            : this.$set(e.collapsed, t, 1);
      },
      onClear(e) {
        this.root.removeFacetFilter(this.facet.id, null), a.stopEvent(e);
      },
      onRangeSliderInput(e) {
        var t = this.root,
          s = t.facetFilters,
          i = this.facet,
          r = i.id,
          a = this.rangeDecimals;
        s || (t.facetFilters = s = {});
        var o = s[r];
        o || ((o = [i.facetName, ""]), this.$set(s, r, o)),
          this.$set(o, 1, [":" + e[0].toFixed(a) + " :" + e[1].toFixed(a)]);
      },
      onRangeInput(t, s, i) {
        var r = this.facet,
          a = this.root.__qr;
        if (r.inverseFormula) {
          var o = this.rangeResolver(parseFloat(t.target.value)),
            l = i ? [this.range[0], (this.range[1] = o)] : [(this.range[0] = o), this.range[1]];
          return this.onRangeSliderInput(l), void this.onRangeSliderChange(l);
        }
        var n = r.min,
          c = r.max,
          u = this.root,
          ...
          f = r.id,
          m = u.facetFilters,
          p = parseFloat(t.target.value);
        if (isNaN(p)) t.target.value = s.toString();
        else {
          p > c ? (p = c) : p < n && (p = n), 1 === i && p < h ? (p = h) : !i && p > d && (p = d);
          var g = [h, d];
          if (((g[i] = p), this.isPrice && g[0] === n && g[1] === c)) m && u.$delete(m, f);
          else {
            var v = ":" + g[0] + " :" + g[1];
            m || (u.facetFilters = m = {});
            var b = m[f];
            b || ((b = [r.facetName, ""]), u.$set(m, f, b)),
              u.$set(b, 1, [v]),
              _usfaq.track("facetFilter", {
                term: a.term,
                filterFacetLabel: v.replace(/\:/g, "").replace(" ", ":"),
                filterFacetName: r.title
              });
          }
          (a.facetFilters = m), e.filterNavigation.scrollUpOnChange && z();
        }
      },
      onRangeSliderChange(t) {
        var s = this.root.facetFilters;
        if (s) {
          var i = this.root.__qr,
            r = this.facet,
            o = r.id;
          if (this.isPrice && t[0] === r.min && t[1] === r.max) this.$delete(s, o);
          else if (s[o]) {
            var l = a.formatNumber,
              n = this.rangeDecimals;
            _usfaq.track("facetFilter", {
              term: i.term,
              filterFacetLabel: l(t[0], n) + ":" + l(t[1], n),
              filterFacetName: r.title
            });
          }
          (i.facetFilters = s), e.filterNavigation.scrollUpOnChange && z();
        }
      }
    }
  };
  usf.components.Filter = usf.register(X, null, "usf-filter");
  var K = {
    ...
    created() {
      var e = this.facet,
        t = e.displayMode;
      (this.isSwatch = 2 === t), (this.isBox = 1 === t);
      var s = this.option,
        r = s.children;
      this.children = r && r.length ? r : null;
      var a = e.swatchImages ? e.swatchImages[e.labelPrefix ? e.labelPrefix + s.label : s.label] : null;
      !a || a.color || a.imageUrl || (a = null),
        (this.swatchImage = a),
        (this.swatchStyle = a
          ? a.imageUrl
          ...
          : null),
        (this.label = r ? s.collection.llabel || s.collection.label : E(s, this.facet, this.swatchImage, usf.isMobile)),
        (this.loc = i);
    },
    data() {
      var e = this.option,
        t = e.children;
      return { collapsed: !(t = t && t.length ? t : null) || (e.collection && l.collection !== e.collection.urlName) };
    },
    computed: {
      isSelected() {
        var e,
          ...
          i = s.id,
          r = this.option;
        r.children && (r = r.collection);
        var a = t.facetFilters ? t.facetFilters[i] : null;
        a && ((a = a[1]), (e = (e = r.id) ? e.toString() : B(r)));
        var l = a && a.includes(e);
        if (o && !l && s.navigationCollections) {
          var n = usf.collectionsByUrlName[o];
          l = n && r.id === n.id;
        }
        return l;
      }
    ...
    methods: {
      getChildLabel(e) {
        switch (this.facet.navigationCollectionsChildType) {
          case "link":
            var t = e.label,
              s = t.indexOf("](");
            return -1 !== s ? t.substring(1, s) : t;
        }
        return e.llabel || e.label;
      },
      isChildSelected(e) {
        return this.isSelected && "tags" === this.facet.navigationCollectionsChildType && G(e.label) === l.tagUrlName;
      },
      onChildClick(e) {
        var t = this.facet,
          s = this.option.collection;
        switch (t.navigationCollectionsChildType) {
          case "tags":
            location = l.getCollectionUrl(s.urlName + "/" + G(e.label));
            break;
          case "productType":
            location = l.getCollectionUrl(s.urlName + "/ProductType:" + e.label);
            break;
          case "vendor":
            location = l.getCollectionUrl(s.urlName + "/Vendor:" + e.label);
            break;
          case "collections":
            location = l.getCollectionUrl(e.urlName);
            break;
          case "link":
            var i = e.label,
              r = i.indexOf("](");
            location = -1 !== r ? i.substring(r + 2, i.length - 1) : i;
        }
      },
      onToggleChildren(e) {
        (this.collapsed = !this.collapsed), a.stopEvent(e);
      },
      onToggle() {
        var t = this.root,
          s = this.option,
          i = this.facet;
        if (i.navigationCollections) {
          var r = s.collection,
            a = new usf.URLSearchParams(location.search);
          return a.delete("page"), void (location = l.getCollectionUrl(r ? r.urlName : s.id) + a.toString());
        }
        var o = s.id;
        o = o ? o.toString() : B(s);
        var n,
        ...
        if (n) {
          var f = n[1],
            m = f.indexOf(o);
          -1 === m ? (h || f.splice(0, f.length), f.push(o)) : (f.splice(m, 1), (d = !1)), f.length || delete c[u];
        } else (n = [i.facetName, [o]]), c || (c = {}), (c[u] = n);
        c && (t.__qr.facetFilters = c),
          i.multiple || (usf.isMobile ? (t.mobileSelectedFacetId = null) : t.horz && this.$set(t.collapsed, i.id, 1)),
          d && _usfaq.track("facetFilter", { term: t.__qr.term, filterFacetLabel: B(s), filterFacetName: i.title }),
          e.filterNavigation.scrollUpOnChange && z();
      }
    }
  };
  function G(e) {
  ...
  usf.components.FilterOption = usf.register(K, null, "usf-filter-option");
  var Y = {
    template: s.filters,
    data: () => ({
      facets: null,
      ...
      loadedItems: {},
      terms: {},
      mobileSelectedFacetId: null,
      horz: e.filters.horz
    }),
    beforeMount() {
      (this.loc = i), this.__init();
      var e = this.__qr;
      (this.facetFilters = e.facetFilters),
        e.addChangedEventListener(() => {
          this.facetFilters = e.facetFilters;
        });
    },
    mounted() {
      usf.isMobile && document.body.appendChild(this.$el), t.add("mobile_changed", this.__onMobileChanged);
    },
    beforeDestroy() {
      t.remove("sr_updated", this.__onSrUpdated), t.remove("mobile_changed", this.__onMobileChanged);
      try {
        document.body.removeChild(this.$el);
      } catch (e) {}
    },
    ...
    computed: {
      ...
      mobileSelectedFacet() {
        return this.facets ? this.facets.find((e) => e.id === this.mobileSelectedFacetId) : null;
      }
    },
    methods: {
      __init() {
        if ((t.add("sr_updated", this.__onSrUpdated), usf.search)) {
          var e = usf.search.result;
          e && this.__onSrUpdated(null, { facets: e.facets });
        }
        this.__qr = c;
      },
      __onSrUpdated(e, t) {
        var s = t.facets;
        if (s) {
          if (!this.facets && this.horz) for (var i = 0; i < s.length; i++) this.$set(this.collapsed, s[i].id, 1);
          this.facets = [];
          for (i = 0; i < s.length; i++) this.facets[i] = s[i];
        } else this.facets = null;
      },
      __onMobileChanged(e, t) {
        if (usf.isMobile) document.body.appendChild(this.$el);
        else {
          var s,
            i = this.$parent;
          do {
            var r = i.$el;
            if ((s = r.querySelector(".usf-facets-container"))) break;
            "usf_container" === r.id && (s = r), (i = i.$parent);
          } while (i);
          s.insertBefore(this.$el, s.children[0]);
        }
      },
      canShowFilter(e) {
        if (void 0 !== e.min) return e.min !== e.max;
        if (e.navigationCollections) {
          var t = e.navigationCollectionsMenu;
          if (t) return t.length;
        }
        return e.labels.length;
      },
      formatBreadcrumbLabel: q,
      formatFacetLabel: V,
      onMobileBack(e) {
        e || this.singleFacetMode ? this.$el.classList.remove("usf-on") : (this.mobileSelectedFacetId = null);
      },
      onMobileSelectFacet(e) {
        this.mobileSelectedFacetId = e.id;
      },
      applyFacetFilters(e) {
        this.__qr.facetFilters = e;
      },
      selectFacetFilter(e) {
        var t,
          s = e.facetName,
          i = e.id,
          r = this.facetFilters;
        r && (t = r[i]), t || ((t = [s, []]), r || (r = {}), (r[i] = t));
        var a = t[1],
          o = "collections" === s;
        e.labels.forEach((e) => {
          -1 === a.indexOf(e) && a.push(o ? e.id : e.label);
        }),
          (this.__qr.facetFilters = r);
      },
      removeFacetFilter(e, t) {
        var s = this.facetFilters;
        if (s) {
          if (t) {
            var i = s[e];
            if (!i) return;
            var r = i[1],
              a = r.indexOf(t);
            -1 === a ? r.push(label) : r.splice(a, 1), r.length || delete s[e];
          } else delete s[e];
          this.__qr.facetFilters = s;
        }
      },
      removeAllFacetFilters() {
        this.__qr.removeAllFacetFilters();
      }
    }
  };
  function J(e) {
    var t = e.navigationCollectionsMenu;
    if (t) {
      for (var s = e.labels, i = [], r = 0; r < t.length; r++) {
        var a = t[r],
          o = s.find((e) => e.id === a.collection.id);
        o ? i.push(Object.assign({ id: o.id, value: o.value }, a)) : e.navigationCollectionsKeepMain && i.push(a);
      }
      return i;
    }
  }
  usf.components.Filters = usf.register(Y, null, "usf-filters");
  var Q = {
      data() {
        var e = c.term;
        return {
      ...
      created() {
        ...
        if (t) {
          ...
          this.sortByOptions = s;
        } else this.sortByOptions = null;
        this.loc = i;
      },
      computed: {
        hasResults() {
          return this.result && this.result.items.length;
        },
        noFacets() {
          return !this.hasFacets && !this.facetFilters;
        },
        filtersCount() {
          var e = this.facetFilters;
    ...
    ee = "infinite" === Z,
    te = ee || "more" === Z;
  const se = ".usf-results [data-usf-pid]";
  var ie = {
    mixins: [Q],
    template: s.searchResults,
    computed: {
      pagesTotal() {
        var e = this.result;
        return e && e.total ? Math.floor((e.total - 1) / this.itemsPerPage + 1) : 0;
      }
    },
    created() {
      (usf.search = this),
        (this.showSearchBox = o ? e.search.showSearchInputOnCollectionPage : e.search.showSearchInputOnSearchPage);
    },
    beforeMount() {
      n.changed.push(() => {
        var e = n.getChanges();
        if (e.length && (1 !== e.length || "usf_view" !== e[0])) {
          n.snapshot();
          var t = this.term;
          if (
            ((this.term = this.termModel = c.term),
            (this.sortBy = c.sort),
            (this.view = c.view),
            (this.facetFilters = c.facetFilters),
            te)
          ) {
            var s = this.take,
              i = (this.take = c.take);
            if (i > s) return void usf.fetch(this, 1);
            if (i < s && t == this.term && this.result)
              return this.result.items.splice(i, this.result.items.length - i), void (this.itemsLoaded = i);
            (c.take = 0), (this.itemsOffset = 0);
          } else (this.page = c.page), (this.itemsPerPage = c.itemsPerPage);
          c.isViewChanged(e) && this.refresh();
        }
      }),
        T &&
          window.addEventListener("pageshow", () => {
            (ue = 0), n.snapshot(), t.raise("resetstate");
          }),
        n.snapshot(),
        this.refresh();
    },
    mounted() {
      setTimeout(() => {
        if (((ee || te) && de(this), a.installSearchInput(this.$refs.searchInput), e.showGotoTop)) {
          var t = document.createElement("div");
          t.classList.add("usf-goto-top"),
            document.body.appendChild(t),
            a.on(t, "click", function (e) {
              a.scrollTo(0, 800);
            }),
            a.on(
              document,
              ...
              function (e) {
                window.scrollY > 170
                  ? document.body.classList.add("usf-with-goto-top")
                  : document.body.classList.remove("usf-with-goto-top");
              },
              { passive: !0 }
            );
        }
    ...
    methods: {
      ...
      onSortByChanged(e) {
        c.sort = e === this.sortByOptions[0].value ? "" : e;
      },
      clearSearch() {
        (this.termModel = ""), (c.term = "");
      ...
      onGridViewClick() {
        (c.view = ""),
          this.$nextTick(() => {
            t.raise("sr_viewChanged", this, "grid");
          });
      },
      onListViewClick() {
        (c.view = "list"),
          this.$nextTick(() => {
            t.raise("sr_viewChanged", this, "list");
          });
      },
      onLoadMore() {
        c.take = this.itemsLoaded + e.search.itemsPerPage;
      },
      onLoadPrev() {
        (this.itemsOffset -= e.search.itemsPerPage), usf.fetch(this, 2);
      },
      refresh() {
        usf.fetch(this);
      },
  ...
  usf.components.SearchResults = usf.register(ie, null, "usf-sr");
  var re = { props: { position: String, banner: Object }, template: s.searchResultsBanner },
    ae,
    oe,
    le,
    ne,
    ...
    ue;
  function he(e) {
    if ((oe || (oe = document.getElementById("usf-sr-top-loader")), oe) && oe.getBoundingClientRect().top >= 0) {
      ae = !1;
      var t = document.querySelector(se);
      if (t) {
        ce = t.getAttribute("data-usf-pid");
        var s = t.getBoundingClientRect();
        (ne = s.top), e.onLoadPrev();
      }
      return;
    }
  }
  function de(e) {
    function s() {
      if (((le = null), (oe = null), (ae = !0), ne)) {
        var e = document.querySelector('.usf-results [data-usf-pid="' + ce + '"]').getBoundingClientRect();
        window.scrollBy(0, e.top - ne), (ne = 0);
      }
    }
    function i() {
      setTimeout(s, 100);
    ...
    t.add("sr_updated", i),
      ...
      document.addEventListener(
        ...
        function (t) {
          ee &&
            !e.loader &&
            e.itemsLoaded < e.result.total &&
            (le || (le = document.querySelector(".usf-sr-paging")),
            le && le.getBoundingClientRect().top <= window.innerHeight && e.onInfiniteLoad());
          ae && he(e);
        },
        { passive: !0 }
      );
  ...
  function fe() {
    for (var e = usf_container.querySelectorAll(se), t = 0; t < e.length; t++) {
      var s = e[t],
        i = s.getBoundingClientRect();
      if (i.top > 0 || i.bottom > 0) {
        var r = s.getAttribute("data-usf-pid");
        return void me(usf.search.itemsOffset + t, r, i.y);
      }
    }
  }
  function me(t, s, i) {
    if (!ue) {
      ue = 1;
      var r = e.search.itemsPerPage,
        a = { id: s, take: (Math.floor(t / r) + 1) * r, y: i };
      sessionStorage.setItem("usfVP", JSON.stringify(a));
    }
  }
  function pe(e, t) {
    return { type: "page", page: e, current: t };
  }
  usf.components.SearchResultsBanner = usf.register(re, null, "usf-sr-banner");
  var ge = {
    props: {
      page: Number,
      pagesTotal: Number,
      pagesToDisplay: { type: Number, default: 4 },
      sidePagesToDisplay: { type: Number, default: 1 }
    },
    data: () => ({ loc: i }),
    template: s.searchResultsPages,
    computed: {
      elements() {
        var e = this.pagesTotal;
        if (e <= 1) return [];
        this.loc;
        var t = this.page,
          s = this.pagesToDisplay,
          i = this.sidePagesToDisplay,
          r = t > s / 2 + 2 && e > s + 1,
          a = e > s + 1 && t < e - (s / 2 + 1),
          o = [];
        t > 1 && o.push({ type: "prev" });
        var l = 1;
        if (r) {
          for (var n = 1; n <= i; n++) o.push(pe(n));
          (l = i + 1), o.push({ type: "dots" });
        } else for (n = l; n < t - s / 2; n++) o.push(pe(n));
        for (n = 0; n < s / 2; n++) {
          (c = t - s / 2 + n) < l || o.push(pe(c));
        }
        o.push(pe(t, !0));
        for (n = 0; n < s / 2; n++) {
          var c;
        ...
        if (a) {
          o.push({ type: "dots" });
          for (n = e - i + 1; n <= e; n++) o.push(pe(n));
        } else for (n = t + s / 2 + 1; n <= e; n++) o.push(pe(n));
        return t < e && o.push({ type: "next" }), o;
      },
      prevUrl() {
    ...
    methods: {
      getPageUrl: (e) => c.getPageUrl(e),
      onPrev(e) {
        (c.page = this.page - 1), z(), a.stopEvent(e);
      },
      onNext(e) {
        (c.page = this.page + 1), z(), a.stopEvent(e);
      },
      onPage(e, t) {
        return e !== this.page && ((c.page = e), z()), a.stopEvent(t);
      }
    }
  };
  usf.components.SearchResultsPages = usf.register(ge, null, "usf-sr-pages");
  var ve = e.search.priceUnit || "",
    be,
    ye = e.search.imageSize,
    we;
  if (ye) {
    var _e = ye.split(",");
    (ye = _e[usf.isMobile && _e.length > 1 ? 1 : 0]), (e.search.imageSize = ye);
  }
  switch (e.search.imageSizeType) {
    case "dynamic":
      be = "{size}";
  ...
  function Ie(t) {
    var s,
      ...
      n = t.product,
      c = n.variants,
      u = n.selectedVariantId,
      h = u ? c.find((e) => e.id === u) : null,
      d = h || (c.length ? c[0] : null),
      f = d.compareAtPrice,
      m = d.price,
      p = f > m ? f - m : 0,
      g = l.collection,
      v = l.getProductUrl(g, n, h);
    if (h) (s = h.available), (r = 1 & h.flags), (o = s > 0 || -2147483648 === s);
    else {
      s = 0;
      for (var b = 0; b < c.length; b++) {
        var y = c[b];
        if (-2147483648 === y.available) {
          (s = -2147483648), (r = !1), (o = !0);
          break;
        }
        (s += y.available), y.available > 0 && (o = !0), 1 & y.flags && (r = !0);
      }
    }
    var w = !!p;
    (t.collection = g),
      ...
      (t.price = m),
      (t.compareAtPrice = f),
      (t.originalPrice = f > m ? f : m),
      (t.displayPrice = a.getDisplayPrice(t.originalPrice) + ve),
      (t.displayDiscountedPrice = a.getDisplayPrice(t.price) + ve),
      w && ((t.displayDiscount = a.getDisplayPrice(p) + ve), (t.discount = p)),
      (t.selectedVariant = h),
      (t.selectedVariantForPrice = d),
      (t.loc = i),
      (t.scaledSelectedImageUrl = t.getSelectedImageUrl(be)),
      (t.selectedImage = a.getProductImage(t.product, t.selectedVariant)),
      (t.hoverImage = e.search.showAltImage && !u ? $e(n) : null);
  }
  function Se(e) {}
  function xe(e) {
    e.c || (we = 1);
  ...
  var Pe = {
    props: { product: Object, term: String, result: Object, imageSize: { type: String, default: "list" } },
    created() {
      Ie(this);
    },
    data: () => ({ isHover: !1, c: 1 }),
    computed: {
      salePercent() {
        ...
        var e = this.selectedVariantForPrice;
        return Math.ceil(100 - (100 * e.price) / e.compareAtPrice);
      },
      minPrice() {
        var e = this.originalPrice;
        return (
          this.product.variants.forEach((t) => {
            var s = t.compareAtPrice,
              i = t.price,
              r = s > i ? s : i;
            r < e && (e = r);
          }),
      ...
      priceVaries() {
        return this.minDiscountedPrice !== this.maxDiscountedPrice;
      },
      displayMinPrice() {
        return a.getDisplayPrice(this.minPrice) + ve;
      },
      displayMaxPrice() {
        return a.getDisplayPrice(this.maxPrice) + ve;
      },
      displayMinDiscountedPrice() {
        return a.getDisplayPrice(this.minDiscountedPrice) + ve;
      },
      displayMaxDiscountedPrice() {
        return a.getDisplayPrice(this.maxDiscountedPrice) + ve;
      },
      displayLongPrice() {
        return xe(this), a.getLongDisplayPrice(this.originalPrice) + ve;
      },
      displayLongDiscount() {
        return xe(this), a.getLongDisplayPrice(this.discount) + ve;
      },
      displayLongDiscountedPrice() {
        return xe(this), a.getLongDisplayPrice(this.price) + ve;
      },
      image() {
        var e;
        return Se("image"), xe(this), this.isHover && (e = this.hoverImage), e || this.selectedImage;
      },
      scaledHoverImageUrl() {
        return this.getHoverImageUrl(be);
      },
      imageUrl() {
        return Se("imageUrl"), xe(this), this.getImageUrl(this.imageSize);
      },
      selectedImageUrl() {
        return Se("selectedImageUrl"), xe(this), this.getSelectedImageUrl(this.imageSize);
      },
      hoverImageUrl() {
        return Se("hoverImageUrl"), xe(this), this.getHoverImageUrl(this.imageSize);
      },
      originalImageUrl() {
        return Se("originalImageUrl"), xe(this), this.getImageUrl();
      },
      originalSelectedImageUrl() {
        return Se("originalSelectedImageUrl"), xe(this), this.getSelectedImageUrl();
      },
      originalHoverImageUrl() {
        return Se("originalHoverImageUrl"), xe(this), this.getHoverImageUrl();
      },
      scaledImageUrl() {
        return Se("scaledImageUrl"), xe(this), this.getImageUrl(be);
      },
      pluginData() {
        return { product: this.product, isHover: this.isHover, result: this.result, owner: this };
      }
    },
    methods: {
      reset() {
      ...
      onItemClick(e) {
        var t = e.target.closest("[data-usf-pid]"),
          s = this.product;
        ...
        for (var i = usf_container.querySelectorAll(se), r = usf.search.itemsOffset, a = 0, o = 0; o < i.length; o++) {
          var l = i[o];
          if (l === t) {
            (r += o), (a = l.getBoundingClientRect().y);
            break;
          }
        }
        me(r, s.id, a);
      ...
      getImageUrl(e) {
        var t,
          s = this.product;
        return this.isHover && (t = this.getHoverImageUrl(e)), t || a.getProductImageUrl(s, this.selectedVariant, e);
      },
      getSelectedImageUrl(e) {
        return a.getProductImageUrl(this.product, this.selectedVariant, e);
      },
      getHoverImageUrl(t) {
        if (e.search.showAltImage) {
          var s = this.product;
          if (!s.selectedVariantId) return Be(s, t);
        }
      },
      getMetafield(e, t) {
        return a.getMetafield(this.product, e, t);
      },
      setSelectedVariantId(e) {
        var t = this.product,
          s = t.variants.find((t) => t.id === e);
        if (s) return (t.selectedVariantId = e), Ie(this), this.c++, this.$forceUpdate(), s;
      }
    }
  };
  usf.components.SearchResultsItemBase = Pe;
  var Fe = { mixins: [Pe], template: s.searchResultsGridViewItem };
  usf.components.SearchResultsGridItem = usf.register(Fe, null, "usf-sr-griditem");
  var Ce = { mixins: [Pe], template: s.searchResultsListViewItem };
  (usf.components.SearchResultsListItem = usf.register(Ce, null, "usf-sr-listitem")), t.add("is_show", ke);
  var Ue,
    Le = {},
    Me,
    Te;
  function ke(r) {
    if (!Te) {
      Me = e.search.online ? l.baseUrl + e.search.searchResultsUrl : l.searchUrl;
      var o = document.createElement("div");
      document.body.appendChild(o);
      var n = {
        mixins: [Q],
        el: o,
        template: s.instantSearch,
        data: () => ({ left: 0, top: 0, width: 0, show: !1, firstLoader: !0, loader: !0, term: r.value, result: null }),
        computed: {
          isEmpty() {
            var e = this.result;
            return !(e && (e.items.length || (e.pages && e.pages.length) || (e.collections && e.collections.length)));
          },
          hasProductsOnly() {
            var e = this.result;
            return e && (!e.pages || !e.pages.length) && (!e.collections || !e.collections.length);
          },
          queryOrTerm() {
            var e = this.result;
            return e ? e.query : this.term;
          },
          termDiffers() {
            return !this.loader && this.result.query.trim() !== this.term.trim().toLowerCase();
          }
        },
        methods: {
          focus() {
          ...
          close() {
            (this.show = 0), (this.popupFocus = !1), document.documentElement.classList.remove("usf-no-scroll");
          },
          onSearchBoxInput(e) {
            this.updateTerm(e.target.value);
          },
          onClear() {
            this.updateTerm(""), this.$refs.searchInput.focus();
          },
          updateResults(s) {
            var i = this;
            Ue && Ue.abort(), (i.loader = !s || "more");
            var r = usf._refineTerm(i.term);
            s || (i.itemsLoaded = 0);
            var o = { q: r, apiKey: e.siteId };
            r ? i.sortBy && "r" !== i.sortBy && (o.sort = i.sortBy) : (o.sort = "bestselling"),
              s && (o.skip = i.itemsLoaded),
              (o.take = e.instantSearch.numOfProductMatches);
            var n = l.customerTags;
            n && n.length && (o.customerTags = n.join(","));
            var c = l.locale;
            c && (o.locale = c),
              e.instantSearch.showCollections && (o.showCollections = 1),
              e.instantSearch.showPages && (o.showPages = 1),
              this.onSendingData(o),
              t.raise("is_updating", this, o);
            ...
            function h(e) {
              (Le[u] = e),
                ...
                (i.firstLoader = !1),
                (e = JSON.parse(e)),
                t.raise("is_dataReceived", this, e.data),
                i.onDataReceived(o, e.data),
                i.$nextTick(() => {
                  t.raise("is_updated", this, i.result), i.__init();
                });
            }
            var d = Le[u];
            d
              ? h(d)
              : (Ue = a.send({
                  url: e.searchSvcUrl + "instantsearch",
                  data: o,
                  success: h,
                  error: function (e) {
                    (Ue = null), (i.loader = !1);
        ...
        beforeMount() {
          (usf.instantSearch = this),
            (this.searchUrl = Me),
            (this.settings = e.instantSearch),
            (this.loc = i),
            t.add("is_hide", this.close);
        }
      };
      usf.components.InstantSearchBase = n;
      var u = {
        mixins: [n],
        data: { popupFocus: !1, position: "right" },
        computed: {
          shouldShow() {
            return this.show || this.popupFocus;
          }
        },
        beforeMount() {
          t.add("resize", this.onResize),
            document.body.addEventListener("mousedown", (e) => {
              if (this.shouldShow) {
                for (var s = e.target; s && s !== this.$el && s !== this.input; ) {
                  if (s === document.body) {
                    var i = { cancel: !1 };
                    return (
                      t.raise("is_hiding", this, i),
                      i.cancel ? ((this.popupFocus = !0), void a.stopEvent(e)) : void usf.utils.hideInstantSearch()
                    );
                  }
                  s = s.parentNode;
                }
            ...
            document.body.addEventListener("mouseup", (e) => {
              this.shouldShow &&
                setTimeout(() => {
                  this.input.value || (this.popupFocus = !1);
                }, 100);
            });
        },
        methods: {
          __init() {},
          onResize(e) {
            this.show && this.reposition(this.input);
          },
          onSendingData(e) {},
          onDataReceived(e, t) {
            Le[e.q] = this.result = t;
          },
          onItemClick(e) {},
          selectCollection(e) {
            location = l.getCollectionUrl(e.urlName);
          ...
          selectPage(e) {
            location = l.getPageUrl(e);
          },
          updateTerm(e) {
            (this.term = e), this.updateResults();
          },
          search(t) {
            (this.show = 0), (this.popupFocus = !1);
            var s = Me;
            (location.pathname === s && e.search.online) ||
            (window.usf_container && this.input.closest(".usf-sr-inputbox"))
              ? ((this.input.value = t), (c.term = t))
              : (location = s + "?" + c.getTermQuery(t)),
              window.usf_container && usf_container.click(),
              a.hideInstantSearch();
          },
          reposition(e) {
            var t = this;
            if (((this.input = e), usf.isMobile))
              with ((document.documentElement.classList.add("usf-no-scroll"), this))
                (show = 1), (term = e.value), setTimeout(t.focus, 170), updateResults();
            else {
              var s = e.getBoundingClientRect(),
                i = { x: s.x + window.scrollX, y: s.y + window.scrollY };
              o(i), this._posTimeout && clearInterval(this._posTimeout);
              var r = 0,
                a = () => {
                  if (this.shouldShow) {
                    var t = N(e);
                    if (i.y !== t.y || i.x !== t.x) {
                      if ((!e.offsetWidth && !e.offsetHeight) || t.y < 0)
                        return clearInterval(this._posTimeout), void usf.utils.hideInstantSearch();
                      o(t);
                    }
                    ++r >= 25 && clearInterval(this._posTimeout);
                  } else clearInterval(this._posTimeout);
                };
              this._posTimeout = setInterval(a, 200);
            }
            function o(s) {
              var i = s.x,
                r = s.y + e.offsetHeight,
                a = e.offsetWidth,
                o = a,
                l = window.innerWidth,
                n;
              with ((o < 858 && (o = 858),
              i + o > l - 20
                ? ((i = i + a - o), i < 0 ? ((n = "middle"), (i = (l - o) / 2)) : (n = "right"))
                : (n = "left"),
              t))
                (left = i), (top = r), (width = o), (show = 1), (term = e.value), (position = n);
            }
          }
        }
      };
      usf.components.InstantSearch = u;
      var h = {
        mixins: [usf.components.SearchResultsItemBase],
        template: s.instantSearchItem,
        imageSize: "small",
        methods: {
          onItemClick() {
            var e = this.product;
      ...
      (usf.components.InstantSearchItem = usf.register(h, null, "usf-is-item")),
        t.raise("is_init", this),
        (Te = new RVue(usf.components.InstantSearch));
    }
    Te.reposition(r), Te.updateResults(), setTimeout(() => (Te.show = 1), 0);
  }
  t.add("init", function () {
    var i = window.usf_container;
    if (i && usf._canLoadContainer) {
      o = l.collection;
      var r = (usf.app = new RVue({
        el: i,
        template: s.app,
        data: { collection: null, settings: e, hasFilters: !usf.isMobile },
        mounted() {
          (usf.settings = e = this.settings), t.raise("mounted");
        }
      }));
      t.add("sr_updated", function () {
        var e = l.collection;
        if (e) {
          var t = usf.collectionsByUrlName[e];
          r.$set(usf.app, "collection", t || { title: "All products" });
        }
      }),
        t.add(["mobile_changed", "rerender"], function () {
          Ve(r);
          var e = usf.instantSearch;
          e && Ve(e);
        }),
        t.add("resetstate", function () {
          !(function e(t) {
            t.$children.forEach((t) => e(t)), t.reset && t.reset();
          })(r);
        });
    }
  });
  var Ne = {
    ...
    render(e, t) {
      var s = usf.plugins.invoke("render_" + t.props.name, [t.parent, e, t.props.data]);
      return (usf.plugins.lastRenderResult = s), s;
    }
  };
  function De(e, t, s) {
    for (
      ...
      var c = o[n],
        u = c.src;
      u && u.includes(e) && (i++, c.addEventListener("load", a), l++);
    }
    !l && s && s(l);
  }
  function Re(e, t) {
    return e && t ? e.replace(new RegExp(t, "gi"), (e) => '<span class="usf-highlight">' + e + "</span>") : e;
  }
  (usf.components.Plugin = usf.register(Ne, null, "usf-plugin")),
    Object.assign(a, {
      registerScriptsLoadedCallback(e, t, s, i, r, a) {
        var o;
        e
          ? s()
          : (i && (o = setTimeout(r, i)),
            De(
              t,
              function () {
                setTimeout(s, 30), i && clearTimeout(o);
              },
              a
            ));
      },
      getMetafield(e, t, s) {
        var i = e.metafields && e.metafields.find((e) => e.namespace === t && e.key === s);
      ...
      getProductImage(e, t) {
        var s,
          i = 0,
          r = e.images;
        r && t && (s = t.imageIndex) > 0 && s < r.length && (i = s);
        return (r && r[i]) || l.emptyImage;
      },
      getProductImageUrl(e, t, s) {
        var i,
          r = 0,
          a = e.images;
        a && t && (i = t.imageIndex) > 0 && i < a.length && (r = i);
        return (a = a && a[r]), l.getImageUrl((a ? a.url : null) || l.emptyImage.url, s);
      },
      convertPrice: (t) => (e.currencyRate ? t * e.currencyRate : t),
      isVariantSoldOut(e) {
        var t = e._s;
        if (void 0 !== t) return t;
        -2147483648 === e.available ? (t = !1) : (t = !(1 & e.flags) && e.available <= 0);
        return (e._s = t), t;
      },
      getDisplayPrice: (t) => Oe(e.priceFormat, qe(a.convertPrice(t))),
      getLongDisplayPrice: (t) => Oe(e.priceLongFormat, qe(a.convertPrice(t))),
      formatNumber: qe,
      format: function (e) {
        for (var t = 1; t < arguments.length; t++) e = e.replace("{" + (t - 1) + "}", arguments[t]);
        return e;
      },
      encodeHtml: (e) => e.replace(/</g, "&lt;"),
      highlight: Re,
      ensureMobile(s) {
        var i = document.body.clientWidth;
        if (i !== He || !0 === s) {
          He = i;
          var r = i < e.mobileBreakpoint;
          r !== usf.isMobile &&
            ((usf.isMobile = r),
            (usf.isMobileFilter = r && !e.filters.desktopLikeMobile),
            document.body.classList[usf.isMobile ? "add" : "remove"]("usf-mobile"),
            r || (usf.app.hasFilters = !0),
            t.raise("mobile_changed")),
            t.raise("resize", null, { width: i });
        }
      },
      scrollTo(e, t) {
        if (T) return window.scrollTo(0, e);
        const s = document.scrollingElement,
          i = (s && s.scrollTop) || window.pageYOffset,
          r = e - i;
        let a = 0;
        const o = function () {
          const e =
            ...
            (l = i),
            (n = r),
            (s /= t / 2) < 1 ? (n / 2) * s * s * s + l : (n / 2) * ((s -= 2) * s * s + 2) + l);
          var s, l, n;
          window.scrollTo(0, e), a < t && requestAnimationFrame(o);
        };
        o();
      }
    });
  ...
  function Be(e, t) {
    var s = e.images;
    return s && s.length > 1 && l.getImageUrl(s[1].url, t);
  }
  var Ee = 1.7976931348623157e308,
    He;
  function qe(t, s) {
    var i;
    void 0 === s && (s = e.decimals);
    var r = Math.pow(10, s);
    i = Math.round(t * r).toString();
    var a = e.decimalDisplay,
      o = e.useTrailingZeros;
    if (s) {
      var l = i.length;
      if (l > s) {
        var n,
          ...
          u = i.substr(c);
        if (o)
          if (u.length < s) for (; u.length < s; ) u += "0";
          else {
            for (var h = u.length - 1; h > s && "0" == u[h]; ) h--;
            h++, (u = u.substr(0, h));
          }
        else {
          n = !0;
          for (var d = u.length - 1; d >= 0; ) {
            if ("0" !== u[d]) {
              n = !1;
              break;
            }
          ...
          d++, !n && d < u.length && (u = u.substr(0, d));
        }
        i = n ? i.substr(0, c) : i.substr(0, c) + a + u;
      } else if (o) {
    ...
    return f ? i.replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + f) : i;
  }
  function Ve(e) {
    e.$children.forEach((e) => Ve(e)), e.$forceUpdate();
  }
  function ze(e, t, s) {
    var i;
    return function () {
  ...
  a.ready(function () {
    (He = document.body.clientWidth), window.addEventListener("resize", a.ensureMobile);
  }),
    (usf._ios = T);
})();
