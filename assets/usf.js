/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 2/21/2023 7:58:33 PM*/
        ...
        <a :href="productUrl" @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" class="usf-grid__item-link">
            ...
            <div class="w-7/12 text-left">
               ...
               <div class="flex gap-1 relative min-h-[60px]">
                  <div v-if="_usfIsDrop(product)" class="relative top-1 left-1" v-html="_usfIsDrop(product)">
                  </div>
